...
Namespace BLL
    ...
    Public Class RecuperacaoEPrevencaoPerdasBLL
        Inherits BLLClass
        ...
        Public Function ObterRecuperacaoEPrevencaoPerdasSintetico(ByVal NUMCTTFRN As Decimal, _
            ...
            Try
                Dim RecuperacaoEPrevencaoPerdasSintetico As RecuperacaoEPrevencaoPerdasDAL
                RecuperacaoEPrevencaoPerdasSintetico = New RecuperacaoEPrevencaoPerdasDAL
        ...
        Public Function ObterRecuperacaoEPrevencaoPerdasAnalitico(ByVal NUMCTTFRN As Decimal, _
            ...
            Try
                Dim RecuperacaoEPrevencaoPerdasAnalitico As RecuperacaoEPrevencaoPerdasDAL
                RecuperacaoEPrevencaoPerdasAnalitico = New RecuperacaoEPrevencaoPerdasDAL
                Dim DatasetRecuperacaoEPrevencaoPerdas As DatasetRecuperacaoEPrevencaoPerdas
        ...
        Public Function ObterNotasPeriodo(ByVal NUMCTTFRN As Decimal, _
            ...
            Try
                Dim RecuperacaoEPrevencaoPerdasNotasPeriodo As RecuperacaoEPrevencaoPerdasDAL
                RecuperacaoEPrevencaoPerdasNotasPeriodo = New RecuperacaoEPrevencaoPerdasDAL
                Dim DatasetRecuperacaoEPrevencaoPerdas As DatasetRecuperacaoEPrevencaoPerdas
        ...
        Public Function ObterRecuperacaoEPrevencaoPerdasClausulas(ByVal NUMCTTFRN As Decimal) As DatasetRecuperacaoEPrevencaoPerdas
            Try
                Dim RecuperacaoEPrevencaoPerdasClausulas As RecuperacaoEPrevencaoPerdasDAL
                RecuperacaoEPrevencaoPerdasClausulas = New RecuperacaoEPrevencaoPerdasDAL
                Dim DatasetRecuperacaoEPrevencaoPerdas As DatasetRecuperacaoEPrevencaoPerdas
        ...
        Public Function ObterRecuperacaoEPrevencaoPerdasDataApuracao(ByVal NUMCTTFRN As Decimal) As DatasetRecuperacaoEPrevencaoPerdas
            Try
                Dim RecuperacaoEPrevencaoPerdasDataApuracao As RecuperacaoEPrevencaoPerdasDAL
                RecuperacaoEPrevencaoPerdasDataApuracao = New RecuperacaoEPrevencaoPerdasDAL
                Dim DatasetRecuperacaoEPrevencaoPerdas As DatasetRecuperacaoEPrevencaoPerdas
        ...
        Public Function ObterAcordosCanceladosPerdas(ByVal DATAINICIAL As Date, _
            ...
            Try
                Dim RecuperacaoEPrevencaoPerdasAcordosCanceladosPerdas As RecuperacaoEPrevencaoPerdasDAL
                RecuperacaoEPrevencaoPerdasAcordosCanceladosPerdas = New RecuperacaoEPrevencaoPerdasDAL
                Dim DatasetRecuperacaoEPrevencaoPerdas As DatasetRecuperacaoEPrevencaoPerdas
        ...
        Public Function ObterComprador(ByVal CODCPR As Decimal, _
            ...
            Try
                Dim RecuperacaoEPrevencaoPerdasObterComprador As RecuperacaoEPrevencaoPerdasDAL
                RecuperacaoEPrevencaoPerdasObterComprador = New RecuperacaoEPrevencaoPerdasDAL
                Dim DatasetRecuperacaoEPrevencaoPerdas As DatasetRecuperacaoEPrevencaoPerdas
        ...
        Public Function ObterCelulaPorAtributo(ByVal CODDIVCMP As Decimal, _
            ...
            Try
                Dim DatasetCelulaObterCelulaPorAtributo As RecuperacaoEPrevencaoPerdasDAL
                DatasetCelulaObterCelulaPorAtributo = New RecuperacaoEPrevencaoPerdasDAL
        ...
        Public Function ObterDiretoriaCelula(ByVal CODDRTCMP As Decimal) As DatasetDiretoriaCelulas
            Try
                Dim RecuperacaoEPrevencaoPerdas As RecuperacaoEPrevencaoPerdasDAL
                RecuperacaoEPrevencaoPerdas = New RecuperacaoEPrevencaoPerdasDAL
