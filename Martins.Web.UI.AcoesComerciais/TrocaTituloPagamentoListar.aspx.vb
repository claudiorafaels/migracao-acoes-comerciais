Public Class TrocaTituloPagamentoListar
...
#End Region
    ...
    Private Sub btnInserir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnInserir.Click
        Controller.NavegarInserirTrocaTituloPagamento()
    End Sub
    ...
    Private Sub GravarCriteriosDePesquisa(ByVal urlFrame As String)
        ...
        End With
        Session("TrocaTituloPagamentoListar") = criterios
    End Sub
    ...
    Private Sub RestaurarCriteriosDePesquisa(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not Session("TrocaTituloPagamentoListar") Is Nothing Then
            Try
                criterios = CType(Session("TrocaTituloPagamentoListar"), Collection)
