...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TransferenciaGacListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.TransferenciaGacListar" %>
			...
			<TABLE class="tabela1" id="Table1" height="8" cellSpacing="0" cellPadding="0" width="100%"
				...
				<TR>
					...
					<TD class="barra1" width="126" height="19">
						<asp:DropDownList id="cmbCriterio" runat="server" Width="180px" Height="19px" Font-Size="11px" Font-Names="Arial"
					...
					<TD class="barra1" height="19" vAlign="top" align="left">
						...
						<igtxt:WebDateTimeEdit id="txtDataFinal" runat="server" Width="70px" Height="19px" Font-Size="10px" Font-Names="Arial"
							CssClass=""></igtxt:WebDateTimeEdit>
						<asp:Label id="LblFornecedor" runat="server" Visible="False" ForeColor="Black">Fornecedor</asp:Label>
						<igtxt1:WebNumericEdit id="txtCodigo" runat="server" CssClass="" Width="60px"></igtxt1:WebNumericEdit>
						<igtxt:WebTextEdit id="txtNomeFornecedor" runat="server" CssClass="" Font-Names="Arial" Font-Size="11px"
							Width="170px" Visible="False"></igtxt:WebTextEdit>
						<asp:DropDownList id="cmbNomeFornecedor" runat="server" CssClass="" AutoPostBack="True" Font-Names="Arial"
							Font-Size="11px" Height="19px" Width="170px" Visible="False"></asp:DropDownList>
						...
						<asp:DropDownList id="cmbEmpenho" runat="server" Font-Names="Arial" Font-Size="11px" Height="19px"
							Width="120px" Visible="False" CssClass=""></asp:DropDownList></TD>
				</TR>
