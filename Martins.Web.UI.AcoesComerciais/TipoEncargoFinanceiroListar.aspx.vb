Public Class TipoEncargoFinanceiroListar
...
#End Region
    ...
    Private Sub btnInserir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnInserir.Click
        Controller.NavegarInserirTipoEncargoFinanceiro()
    End Sub
    ...
    Private Sub btnPesquisar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPesquisar.Click
        ...
        Try
            ...
            If Me.cmbCriterio.SelectedValue = "0" Then  'Nenhum
                lblFrame.Text = "<iframe src='" & "TipoEncargoFinanceiroListarGrid.aspx?criterio=" & cmbCriterio.SelectedItem.Value & "' height=100% width=100% frameborder=0 ALLOWTRANSPARENCY scrolling=yes></iframe>"
            ElseIf Me.cmbCriterio.SelectedValue = "1" Then  'Consulta por Descrição
                If txtDescricao.Text.Trim.Length < 3 Then
                    ...
                    Exit Try
                End If
                lblFrame.Text = "<iframe src='" & "TipoEncargoFinanceiroListarGrid.aspx?criterio=" & cmbCriterio.SelectedItem.Value & "&DesTipEncFinCttFrn=" & txtDescricao.Text & "' height=100% width=100% frameborder=0 ALLOWTRANSPARENCY scrolling=yes></iframe>"
            ...
            ElseIf cmbCriterio.SelectedValue = "2" Then 'Consulta por Código
                If Not IsNumeric(txtCodigo.Text) Then
                    ...
                    Exit Try
                End If
                lblFrame.Text = "<iframe src='" & "TipoEncargoFinanceiroListarGrid.aspx?criterio=" & cmbCriterio.SelectedItem.Value & "&TipEncFinCttFrn=" & txtCodigo.Text & "' height=100% width=100% frameborder=0 ALLOWTRANSPARENCY scrolling=yes></iframe>"
    ...
    Private Sub GravarCriteriosDePesquisa(ByVal urlFrame As String)
        ...
        End With
        Session("TipoEncargoFinanceiroListar") = criterios
    End Sub
    ...
    Private Sub RestaurarCriteriosDePesquisa(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not Session("TipoEncargoFinanceiroListar") Is Nothing Then
            Try
                criterios = CType(Session("TipoEncargoFinanceiroListar"), Collection)
