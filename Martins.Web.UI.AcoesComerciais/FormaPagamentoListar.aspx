...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FormaPagamentoListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.FormaPagamentoListar" %>
		...
		<form id="Form1" runat="server">
				...
				<tbody>
					<tr>
						<td class="submenu2" vAlign="top" height="28">
							<table id="tbOpcoes" height="0" cellSpacing="0" cellPadding="0" border="0" runat="server">
								<tr>
									<td height="10">
			...
			<TABLE class="tabela1" id="Table1" height="8" cellSpacing="0" cellPadding="0" width="100%"
				...
				<TR>
					...
					<TD class="barra1" width="155" height="19"><asp:dropdownlist id="cmbCriterio" runat="server" CssClass=" " Width="150px" Height="19px" Font-Size="11px"
					...
					<TD class="barra1" vAlign="top" align="left" height="19"><igtxt1:webnumericedit id="txtCODFRN" runat="server" CssClass="" Width="70px" Height="19px" Font-Size="11px"
							Font-Names="Arial" Visible="False" DataMode="Long"></igtxt1:webnumericedit><igtxt1:webtextedit id="txtDescricao" runat="server" CssClass="" Width="150px" Height="19px" Font-Size="11px"
							Font-Names="Arial" Visible="False"></igtxt1:webtextedit></TD>
				</TR>
				<TR id="trEspera" runat="server">
					<TD class="barra1" height="19"></TD>
					<TD class="barra1" align="left" width="155" height="19">
