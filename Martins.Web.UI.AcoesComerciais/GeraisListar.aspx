...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="GeraisListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.GeraisListar" %>
				...
				<tbody>
					<tr>
						<td class="submenu2" vAlign="top" height="28">
							<table cellSpacing="0" cellPadding="0" border="0" runat="server" id="tbOpcoes">
								<tr>
									<td height="10">
				...
				<TR>
					...
					<TD class="barra1" width="126" height="19">
						<asp:DropDownList id="cmbCriterio" runat="server" Width="150px" Height="19px" Font-Size="11px" Font-Names="Arial"
							...
							<asp:ListItem Value="1">FILIAL</asp:ListItem>
							<asp:ListItem Value="2" Selected="True">NENHUM</asp:ListItem>
						</asp:DropDownList></TD>
					<TD class="barra1" height="19" vAlign="top" align="left">
						<asp:DropDownList id="cmbFilial" runat="server" Width="250px" Height="19px" Font-Size="11px" Font-Names="Arial"
							CssClass="" Visible="False"></asp:DropDownList></TD>
				</TR>
