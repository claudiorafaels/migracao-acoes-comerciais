...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ObservacaoFluxoCancelamentoAcordo.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.ObservacaoFluxoCancelamentoAcordo" %>
										...
										<table class="3D" cellSpacing="0" cellPadding="0" border="0">
											<tr>
												<td onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');"><asp:linkbutton id="btnSair" style="TEXT-DECORATION: none" runat="server" CausesValidation="False"
														ToolTip="Sair sem gravar"><IMG height="16" src="../../Imagens/sair.gif" width="16" align="absMiddle"> Sair</asp:linkbutton></td>
											</tr>
										</table>
									</td>
								</tr>
						...
						<td class="darkbox" vAlign="top">
							...
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									...
									<TR>
										<TD class="barra3" style="WIDTH: 72px" width="72">
											<asp:Label id="lblObservacao" runat="server">Label</asp:Label></TD>
										<TD class="barra1" width="100%" colSpan="3">
											<asp:textbox id="txtDESOBSAPV" runat="server" Width="300px" Font-Names="Arial" Font-Size="11px"
												Rows="4" TextMode="MultiLine" MaxLength="180"></asp:textbox></TD>
									</TR>
								</TBODY>
							</TABLE>
						</td>
