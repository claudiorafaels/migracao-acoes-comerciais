...
#End Region
    ...
    Private Sub btnInserir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnInserir.Click
        Controller.NavegarInserirApuracao()
    End Sub
    ...
    Private Sub GravarCriteriosDePesquisa(ByVal urlFrame As String)
        ...
        With criterios
            ...
            .Add(txtNomeFornecedor.Text, "NomeFornecedor")
            .Add(cmbNomeFornecedor.SelectedValue, "cmbNomeFornecedor")

        End With
        Session("ApuracaoListar") = criterios
    End Sub
    ...
    Private Sub RestaurarCriteriosDePesquisa(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not Session("ApuracaoListar") Is Nothing Then
            Try
                criterios = CType(Session("ApuracaoListar"), Collection)
