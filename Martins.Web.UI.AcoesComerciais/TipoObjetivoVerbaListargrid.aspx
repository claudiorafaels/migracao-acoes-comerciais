<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TipoObjetivoVerbaListargrid.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.TipoObjetivoVerbaListarGrid" %>
		...
		<P>
			<form id="Form1" method="post" runat="server">
				<asp:datagrid id="dtgListar" runat="server" Width="800px" Font-Size="X-Small" AutoGenerateColumns="False"
					CssClass=" " DataKeyField="TIPOBJDSNVBA" PageSize="20" AllowPaging="True">
					...
					<Columns>
						...
						<asp:BoundColumn DataField="TIPOBJDSNVBA" SortExpression="TIPOBJDSNVBA" HeaderText="CODIGO">
							<HeaderStyle HorizontalAlign="Right" Width="70px"></HeaderStyle>
							<ItemStyle HorizontalAlign="Right"></ItemStyle>
						</asp:BoundColumn>
						<asp:BoundColumn DataField="DESOBJDSNVBA" SortExpression="DESOBJDSNVBA" HeaderText="DESCRI&#199;&#195;O"></asp:BoundColumn>
						<asp:BoundColumn DataField="DATDSTTIPOBJDSNVBA" SortExpression="DATDSTTIPOBJDSNVBA" HeaderText="DATA DESATIVA&#199;&#195;O"></asp:BoundColumn>
					</Columns>
