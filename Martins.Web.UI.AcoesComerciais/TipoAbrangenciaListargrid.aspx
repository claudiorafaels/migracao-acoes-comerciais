<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TipoAbrangenciaListargrid.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.TipoAbrangenciaListarGrid" %>
		...
		<P>
			<form id="Form1" method="post" runat="server">
				<asp:datagrid id="dtgListar" runat="server" Width="800px" Font-Size="X-Small" AutoGenerateColumns="False"
					CssClass=" " DataKeyField="TipAbgTabPcoCttFrn" PageSize="20" AllowPaging="True">
					...
					<Columns>
						...
						<asp:BoundColumn DataField="TipAbgTabPcoCttFrn" SortExpression="TipAbgTabPcoCttFrn" HeaderText="CODIGO">
							<HeaderStyle HorizontalAlign="Right" Width="70px"></HeaderStyle>
							<ItemStyle HorizontalAlign="Right"></ItemStyle>
						</asp:BoundColumn>
						<asp:BoundColumn DataField="DesTipAbgTabPcoCtt" SortExpression="DesTipAbgTabPcoCtt" HeaderText="DESCRI&#199;&#195;O"></asp:BoundColumn>
					</Columns>
