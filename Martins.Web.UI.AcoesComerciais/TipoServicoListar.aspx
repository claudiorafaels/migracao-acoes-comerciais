...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TipoServicoListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.TipoServicoListar" %>
		...
		<form id="Form1" runat="server">
			...
			<TABLE class="tabela1" id="Table1" height="8" cellSpacing="0" cellPadding="0" width="100%"
				...
				<TR>
					...
					<TD class="barra1" vAlign="top" align="left" height="19"><igtxt1:webtextedit id="txtDescricao" runat="server" CssClass=" " Font-Names="Arial" Font-Size="11px"
							Height="19px" Width="150px" Visible="False"></igtxt1:webtextedit><igtxt1:webnumericedit id="txtCodigo" runat="server" CssClass=" " Font-Names="Arial" Font-Size="11px"
							Height="19px" Width="60px" Visible="False"></igtxt1:webnumericedit></TD>
				</TR>
