...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ApuracaoListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.ApuracaoListar" %>
			...
			<TABLE class="tabela1" id="Table1" height="8" cellSpacing="0" cellPadding="0" width="100%"
				...
				<TR>
					...
					<TD class="barra1" height="19" vAlign="top" align="left">
						...
						<igtxt1:WebNumericEdit id="txtCodigo" runat="server" Width="60px" CssClass=""></igtxt1:WebNumericEdit>
