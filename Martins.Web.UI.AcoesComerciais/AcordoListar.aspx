...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AcordoListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.AcordoListar" %>
		...
		<form id="Form1" runat="server">
			...
			<TABLE class="tabela1" id="Table1" height="8" cellSpacing="0" cellPadding="0" width="100%"
				...
				<TR>
					...
					<TD class="barra1" width="126" height="19"><asp:dropdownlist id="cmbCriterio" runat="server" Width="150px" Height="19px" Font-Size="11px" Font-Names="Arial"
							AutoPostBack="True" CssClass="">
							<asp:ListItem Value="1">PER&#205;ODO</asp:ListItem>
							<asp:ListItem Value="2">DATA PREVIS&#195;O</asp:ListItem>
							<asp:ListItem Value="3">PER&#205;ODO/FORNECEDOR</asp:ListItem>
							<asp:ListItem Value="4" Selected="True">ACORDO</asp:ListItem>
						</asp:dropdownlist></TD>
					<TD class="barra1" vAlign="top" align="left" height="19"><igtxt:webdatetimeedit id="txtDataInicial" runat="server" Width="70px" Height="19px" Font-Size="11px" Font-Names="Arial"
							CssClass="" MinValue="1950-12-31" MaxValue="2025-12-31" Visible="False"></igtxt:webdatetimeedit><asp:label id="LblA" runat="server" Visible="False" ForeColor="Black">A</asp:label><igtxt:webdatetimeedit id="txtDataFinal" runat="server" Width="70px" Height="19px" Font-Size="11px" Font-Names="Arial"
							CssClass="" MinValue="1950-12-31" MaxValue="2025-12-31" Visible="False"></igtxt:webdatetimeedit><asp:label id="LblFornecedor" runat="server" Visible="False" ForeColor="Black">Fornecedor</asp:label><igtxt:webnumericedit id="txtCodigo" runat="server" Width="60px" Height="19px" Font-Size="11px" Font-Names="Arial"
							AutoPostBack="True" CssClass="" DataMode="Decimal" MaxLength="10"></igtxt:webnumericedit><asp:dropdownlist id="cmbNomeFornecedor" runat="server" Width="170px" Height="19px" Font-Size="11px"
							Font-Names="Arial" AutoPostBack="True" CssClass="" Visible="False"></asp:dropdownlist><igtxt:webtextedit id="txtNomeFornecedor" runat="server" Width="170px" Font-Size="11px" Font-Names="Arial"
							CssClass="" Visible="False"></igtxt:webtextedit><asp:linkbutton id="btnBuscarFornecedor" style="TEXT-DECORATION: none" runat="server" Visible="False">
				...
				<TR id="trEspera" runat="server">
					...
					<TD class="barra1" align="left" width="126" height="19">
						<DIV align="left" runat="server"><asp:image id="Espera" runat="server" ImageUrl="../Imagens/espera.gif"></asp:image>&nbsp;Carregando...
						</DIV>
					</TD>
					<TD class="barra1" vAlign="top" align="left" height="19"></TD>
				</TR>
			</TABLE>
			<TABLE>
				<TR>
					<TD colSpan="3" height="14"><asp:validationsummary id="ValidationSummary1" runat="server" Width="672px" DisplayMode="SingleParagraph"></asp:validationsummary></TD>
				</TR>
				<TR>
					<TD align="left" colSpan="3" height="19">
						<table height="400" cellSpacing="0" cellPadding="0" width="887" align="center" border="0">
							<TR>
								<TD vAlign="top" width="98%" height="400"><asp:label id="lblFrame" runat="server"></asp:label></TD>
							</TR>
						</table>
					</TD>
				</TR>
				...
				<td vAlign="top" width="915" height="100%"></td>
			</tr>
			<tr>
				<td class="darkbox" vAlign="top" width="915" height="10">&nbsp;</td>
			</tr>
			</TBODY></TABLE>
			<DIV></DIV>
		</form>
