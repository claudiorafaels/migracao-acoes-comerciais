...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RelatorioConferenciaAcaoTatica.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.RelatorioConferenciaAcaoTatica" %>
					...
					<tr>
						<td class="darkbox" vAlign="top">
							...
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									<TR>
										<TD class="barra3" style="WIDTH: 94px">Opções</TD>
										<TD class="barra1" colSpan="3"><asp:radiobuttonlist id="rdlOpcoes" runat="server" CssClass="" Width="100%" ForeColor="Black">
												<asp:ListItem Value="1" Selected="True">Anal&#237;tico</asp:ListItem>
												<asp:ListItem Value="2">Sint&#233;tico</asp:ListItem>
											</asp:radiobuttonlist></TD>
									</TR>
									<TR>
										<TD class="barra3" style="WIDTH: 94px; HEIGHT: 39px">Fornecedor:</TD>
										<TD class="barra1" style="HEIGHT: 39px" colSpan="3"><uc1:wucfornecedor id="ucFornecedor" runat="server"></uc1:wucfornecedor>&nbsp;
											<asp:label id="Label1" runat="server" ForeColor="Black">Para selecionar todos fornecedores informe 0 (zero) no código</asp:label></TD>
									</TR>
									<TR>
										<TD class="barra3" style="WIDTH: 93px">Mês Referência:</TD>
										<TD class="barra1" colSpan="3"><igtxt:webmaskedit id="txtMesAnoReferencia" runat="server" CssClass="" Width="64px" RealText="&#19;&#19;/&#19;&#19;&#19;&#19;"
												InputMask="##/####"></igtxt:webmaskedit></TD>
									</TR>
									<TR>
									</TR>
								</TBODY>
