...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="UnidadePagamentoListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.UnidadePagamentoListar" %>
				...
				<TR>
					...
					<TD class="barra1" height="19" vAlign="top" align="left">
						...
						<igtxt1:WebNumericEdit id="txtCodigo" runat="server" CssClass=" " Font-Names="Arial" Font-Size="11px" Height="19px"
							Width="60px" MaxLength="10" Visible="False"></igtxt1:WebNumericEdit></TD>
				</TR>
