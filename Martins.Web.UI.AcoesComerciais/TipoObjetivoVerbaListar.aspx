...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TipoObjetivoVerbaListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.TipoObjetivoVerbaListar" %>
			...
			<TABLE class="tabela1" id="Table1" height="8" cellSpacing="0" cellPadding="0" width="100%"
				...
				<TR>
					...
					<TD class="barra1" height="19" vAlign="top" align="left">
						...
						<igtxt1:WebNumericEdit id="txtCodigo" runat="server" CssClass=" " Font-Names="Arial" Font-Size="11px" Height="19px"
							Width="60px" Visible="False"></igtxt1:WebNumericEdit></TD>
				</TR>
