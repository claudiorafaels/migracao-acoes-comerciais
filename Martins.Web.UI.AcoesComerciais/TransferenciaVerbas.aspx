...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TransferenciaVerbas.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.TransferenciaVerbas" %>
										...
										<table class="3D" cellSpacing="0" cellPadding="0" border="0">
											<tr>
												<td onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');"><asp:linkbutton id="btnCancelar" style="TEXT-DECORATION: none" runat="server" CausesValidation="False"
														href="TransferenciaVerbasListar.aspx"><IMG height="16" src="../Imagens/office/Sair.gif" width="16" align="absMiddle"> Sair</asp:linkbutton></td>
											</tr>
										</table>
									</td>
									<td>
					...
					<tr>
						<td class="darkbox" vAlign="top">
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									<TR>
										<TD class="barra3">Data Negociação:</TD>
										<TD class="barra1"><igtxt:webdatetimeedit id="WebDateTimeEdit1" runat="server" CssClass="input." Width="100px" Height="19px"></igtxt:webdatetimeedit></TD>
										<TD class="barra3">Pedido:</TD>
										<TD class="barra1"><igtxt:webtextedit id="WebTextEdit3" runat="server" CssClass="input." Width="100px" Height="19px"></igtxt:webtextedit></TD>
									</TR>
									<TR>
									</TR>
								</TBODY>
