...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TipoPedidoCompra.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.TipoPedidoCompra" %>
					...
					<tr>
						<td class="darkbox" vAlign="top">
							...
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									<TR>
										<TD class="barra3" style="WIDTH: 18px">Código:</TD>
										<TD class="barra1" colSpan="3"><igtxt:webnumericedit id="txtTIPPEDCMP" runat="server" Font-Names="Arial" CssClass=" " Font-Size="11px"
												Width="70px" Height="19px"></igtxt:webnumericedit></TD>
									</TR>
									<TR>
										<TD class="barra3" style="WIDTH: 18px">Descrição:</TD>
										<TD class="barra1" colSpan="3"><igtxt:webtextedit id="txtDESTIPPEDCMP" runat="server" Font-Names="Arial" CssClass=" " Font-Size="11px"
												Width="300px" Height="19px"></igtxt:webtextedit></TD>
									</TR>
									<TR>
										<TD class="barra3" style="WIDTH: 18px">Calcular Preço?</TD>
										<TD class="barra1" colSpan="3"><asp:checkbox id="chkFLGCALPCOMER" runat="server" Font-Names="Arial" CssClass=" " Font-Size="11px"></asp:checkbox></TD>
									</TR>
									<TR>
										<TD class="barra3" style="WIDTH: 18px; HEIGHT: 22px">Cláusula:</TD>
										<TD class="barra1" style="HEIGHT: 22px" colSpan="3"><asp:dropdownlist id="cmbClausula" runat="server" Font-Names="Arial" CssClass="" Font-Size="11px"
												Width="250px" Height="19px"></asp:dropdownlist></TD>
									</TR>
									<TR>
									</TR>
								</TBODY>
