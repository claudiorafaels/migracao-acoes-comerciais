...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RelatorioAcordosCanceladosPerdas.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.AcordosCanceladosPerdas" %>
							...
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									<TR>
										...
										<TD class="barra1" colSpan="3"><igtxt:webdatetimeedit id="txtDataInicial" runat="server" Width="70px" CssClass="" Font-Size="11px" Font-Names="Arial"
									...
									<TR id="trComprador" runat="server">
										...
										<TD class="barra1" colSpan="3"><uc1:wuccomprador id="WucComprador" runat="server"></uc1:wuccomprador></TD>
									</TR>
									<TR>
										<TD class="barra3">Célula:</TD>
										<TD class="barra1" colSpan="3"><uc1:wuccelula id="WucCelula" runat="server"></uc1:wuccelula></TD>
									</TR>
									<TR>
									</TR>
								</TBODY>
