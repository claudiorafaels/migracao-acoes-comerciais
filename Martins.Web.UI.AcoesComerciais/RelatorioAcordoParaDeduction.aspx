...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RelatorioAcordoParaDeduction.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.RelatorioAcordoParaDeduction" %>
...
//-->
	...
	<body onload="MM_preloadImages('../Imagens/lastpost.gif')">
		<form id="Form1" method="post" runat="server">
			<table id="Table2" cellSpacing="0" cellPadding="0" width="10" border="0">
				<tr>
			...
			<table id="Table3" style="WIDTH: 100%; HEIGHT: 67px" height="67" cellSpacing="0" cellPadding="0"
				width="100%" border="0">
				<tbody>
					<tr>
						<td class="submenu2" vAlign="top">
							<table id="tbOpcoes" cellSpacing="0" cellPadding="0" border="0" runat="server">
								<tr>
									<td>
										<table class="3D" id="Table5" cellSpacing="0" cellPadding="0" border="0">
											<tr>
									...
									<td>
										<table class="3D" id="Table6" cellSpacing="0" cellPadding="0" border="0">
											<tr>
									...
									<td>
										<table class="3D" id="Table7" cellSpacing="0" cellPadding="0" border="0">
											<tr>
									...
									<td>
										<table class="3D" id="Table8" cellSpacing="0" cellPadding="0" border="0">
											<tr>
												<td onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');"></td>
											</tr>
										</table>
					...
					<tr>
						<td class="darkbox" vAlign="top">
							...
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									<TR>
										<TD class="barra3">Período:</TD>
										<TD class="barra1" colSpan="3"><igsch:webdatechooser id="txtDatInicial" runat="server" Font-Names="Arial" Font-Size="11px">
												<EditStyle Font-Size="11px" Font-Names="Arial" CssClass=""></EditStyle>
											...
											<igsch:webdatechooser id="txtDatFinal" runat="server" Font-Names="Arial" Font-Size="11px">
												<EditStyle Font-Size="11px" Font-Names="Arial" CssClass=""></EditStyle>
												<CalendarLayout FooterFormat="Today: {0:d}" MaxDate=""></CalendarLayout>
									...
									<TR>
										...
										<TD class="barra1" colSpan="3"><asp:dropdownlist id="cmbCelula" runat="server" Font-Names="Arial" Font-Size="11px" Height="19px"
												Width="250px" CssClass="" AutoPostBack="True"></asp:dropdownlist></TD>
									</TR>
									<TR>
									...
									<TR>
										<TD class="barra3">Forma de Pagamento :</TD>
										<TD class="barra1" colSpan="3"><asp:dropdownlist id="cmbFormaPagamento" runat="server" Font-Names="Arial" Font-Size="11px" Height="19px"
												Width="250px" CssClass="" AutoPostBack="True"></asp:dropdownlist></TD>
									</TR>
									<TR>
										<TD class="barra3">Opções:</TD>
										<TD class="barra1" colSpan="3"><asp:checkbox id="Associado" runat="server" Checked="True" Text="Associado" ForeColor="Black"
												AutoPostBack="True"></asp:checkbox>&nbsp;
											<asp:checkbox id="Efetivado" runat="server" Text="Efetivado" ForeColor="Black" AutoPostBack="True"></asp:checkbox></TD>
									</TR>
									<TR>
									</TR>
								</TBODY>
