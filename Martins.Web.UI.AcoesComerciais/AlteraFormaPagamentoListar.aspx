...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AlteraFormaPagamentoListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.AlteraFormaPagamentoListar" %>
			...
			<TABLE class="tabela1" id="Table1" height="8" cellSpacing="0" cellPadding="0" width="100%"
				...
				<TR>
					...
					<TD class="barra1" vAlign="top" align="left" height="19"><igtxt:webdatetimeedit id="txtDataInicial" runat="server" Font-Names="Arial" Font-Size="10px" Height="19px"
							...
							Width="70px" Visible="False"></igtxt:webdatetimeedit><asp:label id="LblFornecedor" runat="server" Visible="False">Fornecedor</asp:label>
						<igtxt1:WebNumericEdit id="txtCodigo" runat="server" Width="60px"></igtxt1:WebNumericEdit><asp:dropdownlist id="cmbNomeFornecedor" runat="server" Font-Names="Arial" Font-Size="10px" Height="19px"
							Width="170px" Visible="False"></asp:dropdownlist><asp:linkbutton id="btnBuscarFornecedor" style="TEXT-DECORATION: none" runat="server" Visible="False">
							<img src="../Imagens/office/procurar.gif" width="16" height="16" align="absMiddle"></asp:linkbutton>
						<asp:TextBox id="txtNomeFornecedor" runat="server"></asp:TextBox></TD>
				</TR>
