...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RelacaoUsuarioCelula.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.RelacaoUsuarioCelula" %>
										...
										<table class="3D" cellSpacing="0" cellPadding="0" border="0">
											<tr>
												<td onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');"><asp:linkbutton id="btnCancelar" style="TEXT-DECORATION: none" runat="server" CausesValidation="False"
														href="RelacaoUsuarioCelulaListar.aspx"><IMG height="16" src="../Imagens/office/Sair.gif" width="16" align="absMiddle"> Sair</asp:linkbutton></td>
											</tr>
										</table>
									</td>
									<td>
					...
					<tr>
						<td class="darkbox" vAlign="top">
							...
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									<TR>
										<TD class="barra3" style="HEIGHT: 15px">Célula:</TD>
										<TD class="barra1" colSpan="3" style="HEIGHT: 15px">
											<asp:DropDownList id="ddlCelula" runat="server" Width="200px" Height="19px"></asp:DropDownList></TD>
									</TR>
									<TR>
										<TD class="barra3">Usuário:</TD>
										<TD class="barra1" colSpan="3">
											<asp:DropDownList id="ddlUsuario" runat="server" Width="200px" Height="19px"></asp:DropDownList></TD>
									</TR>
									<TR>
									</TR>
								</TBODY>
