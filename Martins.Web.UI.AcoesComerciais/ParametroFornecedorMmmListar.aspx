...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ParametroFornecedorMmmListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.ParametroFornecedorMmmListar" %>
			...
			<TABLE class="tabela1" id="Table1" height="8" cellSpacing="0" cellPadding="0" width="100%"
				...
				<TR>
					...
					<TD class="barra1" height="19" vAlign="top" align="left">
						<uc1:wucFornecedor id="wucCODFRN" runat="server"></uc1:wucFornecedor>
