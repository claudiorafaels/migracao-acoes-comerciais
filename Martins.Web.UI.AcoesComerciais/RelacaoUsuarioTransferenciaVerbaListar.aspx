...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RelacaoUsuarioTransferenciaVerbaListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.RelacaoUsuarioTransferenciaVerbaListar" %>
	...
	<BODY onload="MM_preloadImages('../Imagens/lastpost.gif')">
		<form id="Form1" runat="server">
			...
			<TABLE class="tabela1" id="Table1" height="8" cellSpacing="0" cellPadding="0" width="100%"
				border="0">
				<TR>
					<TD class="barra3" height="18" widTD="10%">Critério:
					</TD>
					<TD class="barra1" width="126" height="18">
						<asp:DropDownList id="cmbCriterio" runat="server" Width="150px" Height="19px" Font-Size="11px" Font-Names="Arial"
							...
							<asp:ListItem Value="1">TIPO TRANSFERENCIA</asp:ListItem>
							<asp:ListItem Value="2" Selected="True">USUARIO</asp:ListItem>
						</asp:DropDownList></TD>
					<TD class="barra1" height="18" vAlign="top" align="left">
						<asp:DropDownList id="cmbUsuario" runat="server" Font-Names="Arial" Font-Size="11px" Height="19px"
							Width="200px" CssClass=""></asp:DropDownList>
						<asp:DropDownList id="cmbTipoTransferencia" runat="server" Font-Names="Arial" Font-Size="11px" Height="19px"
							Width="200px" Visible="False" CssClass=""></asp:DropDownList></TD>
				</TR>
