Public Class TipoAbrangenciaListar
...
#End Region
    ...
    Private Sub btnInserir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnInserir.Click
        Controller.NavegarInserirTipoAbrangencia()
    End Sub
    ...
    Private Sub btnPesquisar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPesquisar.Click
        ...
        Try
            'Verifica o critério
            If Me.cmbCriterio.SelectedValue = "0" Then      'Nenhum critério de filtro
                lblFrame.Text = "<iframe src='" & "TipoAbrangenciaListarGrid.aspx?criterio=" & cmbCriterio.SelectedItem.Value & "' height=100% width=100% frameborder=0 ALLOWTRANSPARENCY scrolling=yes></iframe>"
            ElseIf Me.cmbCriterio.SelectedValue = "1" Then  'Consulta por Descrição
                If txtDescricao.Text.Trim.Length < 3 Then
                    ...
                    Exit Try
                End If
                lblFrame.Text = "<iframe src='" & "TipoAbrangenciaListarGrid.aspx?criterio=" & cmbCriterio.SelectedItem.Value & "&DesTipAbgTabPcoCtt=" & txtDescricao.Text & "' height=100% width=100% frameborder=0 ALLOWTRANSPARENCY scrolling=yes></iframe>"
            ...
            ElseIf cmbCriterio.SelectedValue = "2" Then 'Consulta por Código
                If Not IsNumeric(txtCodigo.Text) Then
                    ...
                    Exit Try
                End If
                lblFrame.Text = "<iframe src='" & "TipoAbrangenciaListarGrid.aspx?criterio=" & cmbCriterio.SelectedItem.Value & "&TipAbgTabPcoCttFrn=" & txtCodigo.Text & "' height=100% width=100% frameborder=0 ALLOWTRANSPARENCY scrolling=yes></iframe>"
    ...
    Private Sub cmbCriterio_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbCriterio.SelectedIndexChanged
        ...
        If cmbCriterio.SelectedValue = "1" Then     '1 Descrição
            txtDescricao.Visible = True
        ElseIf cmbCriterio.SelectedValue = "2" Then '2 Código
    ...
    Private Sub GravarCriteriosDePesquisa(ByVal urlFrame As String)
        ...
        End With
        Session("TipoAbrangenciaListar") = criterios
    End Sub
    ...
    Private Sub RestaurarCriteriosDePesquisa(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not Session("TipoAbrangenciaListar") Is Nothing Then
            Try
                criterios = CType(Session("TipoAbrangenciaListar"), Collection)
