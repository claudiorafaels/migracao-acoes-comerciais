<%@ Page Language="vb" AutoEventWireup="false" Codebehind="BancoListargrid.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.BancoListarGrid" %>
		...
		<P>
			<form id="Form1" method="post" runat="server">
				<asp:datagrid id="dtgListar" runat="server" Width="800px" Font-Size="X-Small" AutoGenerateColumns="False"
					CssClass=" " DataKeyField="CODBCO" PageSize="20" AllowPaging="True">
					...
					<Columns>
						...
						<asp:BoundColumn DataField="CODBCO" SortExpression="CODBCO" HeaderText="CODIGO">
							<HeaderStyle Width="80px"></HeaderStyle>
						</asp:BoundColumn>
						<asp:BoundColumn DataField="NOMBCO" SortExpression="NOMBCO" HeaderText="NOME"></asp:BoundColumn>
						<asp:BoundColumn DataField="NUMCGCBCO" SortExpression="NUMCGCBCO" HeaderText="CNPJ">
