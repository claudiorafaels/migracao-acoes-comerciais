...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RelatorioContrato.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.RelatorioContrato" %>
						...
						<td class="darkbox" vAlign="top">
							...
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									...
									<TR>
										<TD class="barra3">Contrato:</TD>
										<TD class="barra1" colSpan="3"><asp:dropdownlist id="cmbContrato" runat="server" Height="19px" Font-Names="Arial" AutoPostBack="True"
												Font-Size="11px" Width="104px" CssClass=""></asp:dropdownlist></TD>
									</TR>
									<TR>
									</TR>
								</TBODY>
