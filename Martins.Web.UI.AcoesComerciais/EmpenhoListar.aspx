...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="EmpenhoListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.EmpenhoListar" %>
		...
		<form id="Form1" runat="server">
			...
			<TABLE class="tabela1" id="Table1" height="8" cellSpacing="0" cellPadding="0" width="100%"
				...
				<TR>
					...
					<TD class="barra1" width="87" height="19">
						<asp:DropDownList id="cmbCriterio" runat="server" AutoPostBack="True" Font-Names="Arial" Font-Size="11px"
					...
					<TD class="barra1" height="19" vAlign="top" align="left">
						<igtxt1:WebNumericEdit id="txtCODFRN" runat="server" Height="19px" Width="70px" CssClass="" Font-Names="Arial"
							Font-Size="11px" DataMode="Long" MaxLength="10" Visible="False"></igtxt1:WebNumericEdit>
						<igtxt1:WebTextEdit id="txtDescricao" runat="server" Height="19px" Width="150px" Visible="False" CssClass=""
							Font-Names="Arial" Font-Size="11px"></igtxt1:WebTextEdit></TD>
				</TR>
