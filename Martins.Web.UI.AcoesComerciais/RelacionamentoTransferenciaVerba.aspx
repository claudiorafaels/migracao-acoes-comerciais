...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RelacionamentoTransferenciaVerba.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.RelacionamentoTransferenciaVerba" %>
					...
					<tr>
						<td class="darkbox" vAlign="top">
							...
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									<TR>
										<TD class="barra3">Tipo de Transferência:</TD>
										<TD class="barra1" colSpan="3"><asp:dropdownlist id="ddlTipoTransferencia" runat="server" Width="250px" Height="19px" Font-Size="11px"
												Font-Names="Arial" CssClass=""></asp:dropdownlist></TD>
									</TR>
									<TR>
										<TD class="barra3">Relacionar Tipo a:</TD>
										<TD class="barra1" colSpan="3"><asp:dropdownlist id="cmbCriterio" runat="server" Width="250px" Height="19px" Font-Size="11px" Font-Names="Arial"
												CssClass="" AutoPostBack="True">
												<asp:ListItem Value="1" Selected="True">C&#233;lula</asp:ListItem>
												<asp:ListItem Value="2">Fornecedor</asp:ListItem>
											</asp:dropdownlist></TD>
									</TR>
									<TR>
										<TD class="barra3"><asp:label id="lblTip" runat="server">Célula</asp:label>:</TD>
										<TD class="barra1" colSpan="3"><asp:dropdownlist id="ddlCelula" runat="server" Width="250px" Height="19px" Font-Size="11px" Font-Names="Arial"
												CssClass=""></asp:dropdownlist><uc1:wucfornecedor id="ucFornecedor" runat="server" Visible="False"></uc1:wucfornecedor></TD>
									</TR>
									<TR>
										<TD class="barra3">Percentual Transferência:</TD>
										<TD class="barra1" colSpan="3"><igtxt:webpercentedit id="txtPercentual" runat="server" Width="60px" Height="19px" DataMode="Decimal"
												MaxValue="999" MinValue="0" CssClass="" Font-Names="Arial" Font-Size="11px"></igtxt:webpercentedit></TD>
									</TR>
									<TR>
									</TR>
								</TBODY>
