...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RelatorioEvolucaoDosFornecedores.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.RelatorioEvolucaoDosFornecedores" %>
										...
										<table class="3D" cellSpacing="0" cellPadding="0" border="0">
											<tr>
												<td onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');">
													<asp:linkbutton id="Linkbutton1" style="TEXT-DECORATION: none" runat="server" CausesValidation="False"
														Visible="False"><IMG height="16" src="../Imagens/office/imprimir.gif" width="16" align="absMiddle">  Imprimir</asp:linkbutton></td>
											</tr>
										</table>
									</td>
									<td>
						...
						<td class="darkbox" vAlign="top">
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									...
									<TR>
										<TD class="barra3" colSpan="6">
											<P align="left">ESSA OPÇÃO NÃO FOI MIGRADA.</P>
										</TD>
									</TR>
									<TR>
									</TR>
