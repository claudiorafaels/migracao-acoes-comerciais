...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Agencia.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.Agencia" %>
								...
								<tr>
									<td>
										<table class="3D" cellSpacing="0" cellPadding="0" border="0">
											<tr>
												<td onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');"><asp:linkbutton id="btnSalvar" style="TEXT-DECORATION: none" runat="server" Visible="False"><IMG height="16" src="../Imagens/office/salvar.gif" width="16" align="absMiddle"> Salvar</asp:linkbutton></td>
											</tr>
										</table>
									</td>
									<td>
										<table class="3D" cellSpacing="0" cellPadding="0" border="0">
											<tr>
												<td onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');"><asp:linkbutton id="btnCancelar" style="TEXT-DECORATION: none" runat="server" CausesValidation="False"
														href="AgenciaListar.aspx"><IMG height="16" src="../Imagens/office/Sair.gif" width="16" align="absMiddle"> Sair</asp:linkbutton></td>
											</tr>
										</table>
									</td>
									<td>
							...
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									<TR>
										...
										<TD class="barra1" height="19" colSpan="3">
											<P align="left"><INPUT class="" type="hidden" name="flagInclusao"></P>
										</TD>
									</TR>
									<TR>
										<TD class="barra3">Código Agencia:</TD>
										<TD class="barra1" colSpan="3">
											<igtxt:WebNumericEdit id="txtCODAGEBCO" runat="server" Height="19px" Width="70px" Font-Size="11px" CssClass=" "
												Font-Names="Arial"></igtxt:WebNumericEdit></TD>
									</TR>
									<TR>
										<TD class="barra3">Dígito Agencia:</TD>
										<TD class="barra1" colSpan="3">
											<igtxt:WebNumericEdit id="txtNUMDIGVRFAGEBCO" runat="server" Width="70px" Height="19px" Font-Size="11px"
												CssClass=" " Font-Names="Arial"></igtxt:WebNumericEdit></TD>
									</TR>
									<TR>
										<TD class="barra3">Nome Agencia:</TD>
										<TD class="barra1" colSpan="3">
											<igtxt:WebTextEdit id="txtNOMAGEBCO" runat="server" Height="19px" Width="250px" Font-Size="11px" CssClass=" "
												Font-Names="Arial"></igtxt:WebTextEdit></TD>
									</TR>
									<TR>
										<TD class="barra3">Banco:</TD>
										<TD class="barra1" colSpan="3">
											<asp:DropDownList id="cmbCODBCO" runat="server" Width="250px" CssClass=" "></asp:DropDownList></TD>
									</TR>
									<TR>
									</TR>
								</TBODY>
