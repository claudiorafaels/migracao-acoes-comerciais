<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ParametroFornecedorMmmListargrid.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.ParametroFornecedorMmmListarGrid" %>
			...
			<form id="Form1" method="post" runat="server">
				<asp:datagrid id="dtgListar" runat="server" Width="800px" Font-Size="X-Small" AutoGenerateColumns="False"
					...
					<Columns>
						...
						<asp:BoundColumn Visible="False" DataField="CODFRN" SortExpression="CODFRN" HeaderText="CODIGO">
							<HeaderStyle HorizontalAlign="Right" Width="80px"></HeaderStyle>
							<ItemStyle HorizontalAlign="Right"></ItemStyle>
						</asp:BoundColumn>
						<asp:TemplateColumn HeaderText="POSSUI CONTRATO">
							<ItemTemplate>
								<asp:Label id=Label1 runat="server" Text='<%# IIf(DataBinder.Eval(Container, "DataItem.FLGFRNAJTCMC")="S", "SIM", "NÃO") %>'>
								</asp:Label>
							</ItemTemplate>
							<EditItemTemplate>
								<asp:TextBox id=TextBox1 runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FLGFRNAJTCMC") %>'>
								</asp:TextBox>
							</EditItemTemplate>
						</asp:TemplateColumn>
					</Columns>
