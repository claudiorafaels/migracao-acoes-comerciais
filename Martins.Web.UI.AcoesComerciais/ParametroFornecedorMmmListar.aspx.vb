Public Class ParametroFornecedorMmmListar
...
#End Region
    ...
    Private Sub btnInserir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnInserir.Click
        Controller.NavegarInserirParametroFornecedorMmm()
    End Sub
    ...
    Private Sub btnPesquisar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPesquisar.Click
        ...
        Try
            ...
            If Me.cmbCriterio.SelectedValue = "0" Then      'Nenhum
                lblFrame.Text = "<iframe src='" & "ParametroFornecedorMmmListarGrid.aspx?criterio=" & cmbCriterio.SelectedItem.Value & "' height=100% width=100% frameborder=0 ALLOWTRANSPARENCY scrolling=yes></iframe>"
            ElseIf Me.cmbCriterio.SelectedValue = "1" Then  'Fornecedor
                If wucCODFRN.CodFornecedor = 0 Then
                    Page.RegisterStartupScript("Alerta", "<script>alert('Selecione o Fornecedor.');</script>")
                    Exit Try
                End If

                lblFrame.Text = "<iframe src='" & "ParametroFornecedorMmmListarGrid.aspx?criterio=" & cmbCriterio.SelectedItem.Value & "&CODFRN=" & wucCODFRN.CodFornecedor.ToString & "' height=100% width=100% frameborder=0 ALLOWTRANSPARENCY scrolling=yes></iframe>"
            End If
    ...
    Private Sub GravarCriteriosDePesquisa(ByVal urlFrame As String)
        ...
        End With
        Session("ParametroFornecedorMmmListar") = criterios
    End Sub
    ...
    Private Sub RestaurarCriteriosDePesquisa(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not Session("ParametroFornecedorMmmListar") Is Nothing Then
            Try
                criterios = CType(Session("ParametroFornecedorMmmListar"), Collection)
