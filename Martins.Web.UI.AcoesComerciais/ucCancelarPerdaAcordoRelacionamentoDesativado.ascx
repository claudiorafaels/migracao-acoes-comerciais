...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ucCancelarPerdaAcordoRelacionamentoDesativado.ascx.vb" Inherits="Martins.Web.UI.AcoesComerciais.ucCancelarPerdaAcordoRelacionamentoDesativado" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
							...
							<Bands>
								<igtbl:UltraGridBand AddButtonCaption="T0118066" SelectTypeRow="Single" Key="T0118066" AllowDelete="Yes">
									<Columns>
										...
										<igtbl:UltraGridColumn HeaderText="COD. ABRANG&#202;NCIA" Key="" BaseColumnName="">
											<Footer Key="">
												<RowLayoutColumnInfo OriginX="5"></RowLayoutColumnInfo>
											</Footer>
											<Header Key="" Caption="COD. ABRANG&#202;NCIA">
												<RowLayoutColumnInfo OriginX="5"></RowLayoutColumnInfo>
											</Header>
										</igtbl:UltraGridColumn>
										...
										<igtbl:UltraGridColumn HeaderText="ACORDO" Key="" BaseColumnName="">
											<Footer Key="">
												<RowLayoutColumnInfo OriginX="10"></RowLayoutColumnInfo>
											</Footer>
											<Header Key="" Caption="ACORDO">
												<RowLayoutColumnInfo OriginX="10"></RowLayoutColumnInfo>
											</Header>
										</igtbl:UltraGridColumn>
										...
										<igtbl:UltraGridColumn HeaderText="NUM. CL&#193;USULA PERDA" Key="" BaseColumnName="">
											<Footer Key="">
												<RowLayoutColumnInfo OriginX="17"></RowLayoutColumnInfo>
											</Footer>
											<Header Key="" Caption="NUM. CL&#193;USULA PERDA">
												<RowLayoutColumnInfo OriginX="17"></RowLayoutColumnInfo>
											</Header>
										</igtbl:UltraGridColumn>
										...
										<igtbl:UltraGridColumn HeaderText="DAT. DESATIVA&#199;&#195;O" Key="" BaseColumnName="">
											<Footer Key="">
												<RowLayoutColumnInfo OriginX="27"></RowLayoutColumnInfo>
											</Footer>
											<Header Key="" Caption="DAT. DESATIVA&#199;&#195;O">
												<RowLayoutColumnInfo OriginX="27"></RowLayoutColumnInfo>
											</Header>
										</igtbl:UltraGridColumn>
									</Columns>
									...
									<TABLE id="Table3" cellSpacing="0" cellPadding="0" border="0" align="right">
										<TR>
											<TD onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');">
												<asp:linkbutton id="btnSalvar" style="TEXT-DECORATION: none" runat="server"><IMG height="16" src="../Imagens/office/imprimir.gif" width="16" align="absMiddle">  Imprimir Desativo</asp:linkbutton></TD>
										</TR>
									</TABLE>
								</TD>
							</TR>
