<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ProgramaIncentivoManter.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.ProgramaIncentivoManter" %>
							...
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									<TR id="TRCodigo" runat="server">
										...
										<TD class="barra1" width="90%" colSpan="3"><igtxt:webnumericedit id="txtCODPRGICT" runat="server" Width="70px" Enabled="False" Font-Names="Arial"
												Font-Size="11px"></igtxt:webnumericedit></TD>
									</TR>
									<TR id="TRDescricao" runat="server">
										<TD class="barra3" width="10%">Descrição:</TD>
										<TD class="barra1" width="90%" colSpan="3"><igtxt:webtextedit id="txtNOMPRGICT" runat="server" Width="294px" Font-Names="Arial" Font-Size="11px"
												MaxLength="20"></igtxt:webtextedit></TD>
									</TR>
								</TBODY>
							</TABLE>
						</td>
