...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RelacaoProgramaIncentivoManter.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.RelacaoProgramaIncentivoManter" %>
...
<HTML>
	...
	MARGIN: 0px; BACKGROUND-COLOR: #ffffff; scrolling: no
}
		</style>
								...
								<tr>
									<td>
										<table class="3D" cellSpacing="0" cellPadding="0" border="0">
											<tr>
												<td onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');"><asp:linkbutton id="btnSalvar" style="TEXT-DECORATION: none" runat="server" CausesValidation="False"
														Width="64px"><IMG height="16" src="../../Imagens/office/salvar.gif" width="16" align="absMiddle">  Salvar</asp:linkbutton></td>
											</tr>
										</table>
									</td>
									<td>
										<table class="3D" cellSpacing="0" cellPadding="0" border="0">
											<tr>
												<td onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');"><asp:linkbutton id="btnExcluir" style="TEXT-DECORATION: none" runat="server" CausesValidation="False"
														Width="64px"><IMG height="16" src="../../Imagens/office/S_B_CANC.gif" width="16" align="absMiddle">  Excluir</asp:linkbutton></td>
											</tr>
										</table>
									</td>
									<td>
										<table class="3D" cellSpacing="0" cellPadding="0" border="0">
											<tr>
												<td onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');"><asp:linkbutton id="btnSair" style="TEXT-DECORATION: none" runat="server" CausesValidation="False"
														Width="64px"><IMG height="16" src="../../Imagens/office/Sair.gif" width="16" align="absMiddle">  Sair</asp:linkbutton></td>
											</tr>
										</table>
									</td>
								</tr>
							...
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									<TR id="TRCodigo" runat="server">
										...
										<TD class="barra1" width="90%" colSpan="3"><uc1:ucprograma id="UcPrograma" runat="server"></uc1:ucprograma></TD>
									</TR>
