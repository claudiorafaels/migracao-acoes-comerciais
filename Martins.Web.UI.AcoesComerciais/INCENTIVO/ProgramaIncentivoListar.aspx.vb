Public Class ProgramaIncentivoListar
...
#Region "Eventos"
    ...
    Private Sub btnNovo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNovo.Click
        Try
            Response.Redirect("ProgramaIncentivoManter.aspx")
        Catch ex As Exception
            Controller.TrataErro(Me.Page, ex)
        End Try
    End Sub
    ...
    Private Sub btnPesquisar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPesquisar.Click
        Try
            Dim NOMPRGICT As String = String.Empty
            ...
            ElseIf cmbCriterio.SelectedValue = "2" Then
                NOMPRGICT = txtNOMPRGICT.Text
            End If

            CarregaGrid(CODPRGICT, NOMPRGICT)
        Catch ex As Exception
            Controller.TrataErro(Me.Page, ex)
        End Try
    End Sub
    ...
    Private Sub grdIncentivo_ItemCommand1(ByVal sender As Object, ByVal e As Infragistics.WebUI.UltraWebGrid.UltraWebGridCommandEventArgs) Handles grdIncentivo.ItemCommand
        Try
            ...
            If e.InnerCommandEventArgs.CommandName.Equals("btnEditar") Then
                ...
                CODPRGICT = CType(CType(e.ParentControl, Infragistics.WebUI.UltraWebGrid.CellItem).Cell.Row.Cells.FromKey("CODPRGICT").Value, Decimal)

                'Redireciona para página meio
                Response.Redirect("ProgramaIncentivoManter.aspx?CODPRGICT=" & CODPRGICT.ToString)
...
#Region "Métodos de Carga"
    ...
    Private Sub IniciarPagina()
        ...
        grdIncentivo.Visible = False
        Dim CODPRGICT As Decimal = 0
        If Not Request.QueryString("CODPRGICT") Is Nothing Then
            CODPRGICT = CType(Request.QueryString("CODPRGICT"), Decimal)
            CarregaGrid(CODPRGICT)
        End If
    End Sub
    ...
    Public Sub CarregaGrid(ByVal CODPRGICT As Decimal, ByVal NOMPRGICT As String)

        Me.DatasetIncentivo1 = Controller.ObterIncentivoPorAtributo(CODPRGICT, NOMPRGICT)
    ...
    Public Sub CarregaGrid(ByVal CODPRGICT As Decimal)
