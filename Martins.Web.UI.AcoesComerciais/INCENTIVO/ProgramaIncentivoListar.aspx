...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ProgramaIncentivoListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.ProgramaIncentivoListar" %>
							...
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									...
									<TR id="TRCodigo" runat="server">
										...
										<TD class="barra1" width="90%" colSpan="3"><igtxt:webnumericedit id="txtCODPRGICT" runat="server" Width="70px" Font-Size="11px" Font-Names="Arial"></igtxt:webnumericedit></TD>
									</TR>
									<TR id="TRDescricao" runat="server">
										<TD class="barra3" width="10%">Descrição:</TD>
										<TD class="barra1" width="90%" colSpan="3"><igtxt:webtextedit id="txtNOMPRGICT" runat="server" Width="200px" Font-Size="11px" Font-Names="Arial"></igtxt:webtextedit></TD>
									</TR>
								</TBODY>
							</TABLE>
							<igtbl:ultrawebgrid id=grdIncentivo runat="server" Width="614px" Height="308px" ImageDirectory="/ig_common/Images/" DataSource="<%# DatasetIncentivo1 %>" DataMember="CADPRGICT">
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White">
									...
									<FrameStyle Width="614px" BorderWidth="1px" Font-Size="11px" Font-Names="Arial" BorderColor="InactiveCaption"
								...
								<Bands>
									<igtbl:UltraGridBand AddButtonCaption="CADPRGICT" BaseTableName="CADPRGICT" Key="CADPRGICT">
										<Columns>
											...
											<igtbl:UltraGridColumn HeaderText="C&#243;digo" Key="CODPRGICT" IsBound="True" Width="60px" DataType="System.Decimal"
												BaseColumnName="CODPRGICT">
												<CellStyle HorizontalAlign="Center"></CellStyle>
												<Footer Key="CODPRGICT">
													<RowLayoutColumnInfo OriginX="1"></RowLayoutColumnInfo>
												</Footer>
												<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
												<Header Key="CODPRGICT" Caption="C&#243;digo">
													<Style HorizontalAlign="Center">
													</Style>
													<RowLayoutColumnInfo OriginX="1"></RowLayoutColumnInfo>
												</Header>
											</igtbl:UltraGridColumn>
											<igtbl:UltraGridColumn HeaderText="Descri&#231;&#227;o" Key="NOMPRGICT" IsBound="True" Width="500px" BaseColumnName="NOMPRGICT">
												<Footer Key="NOMPRGICT">
													<RowLayoutColumnInfo OriginX="2"></RowLayoutColumnInfo>
												</Footer>
												<Header Key="NOMPRGICT" Caption="Descri&#231;&#227;o">
													<RowLayoutColumnInfo OriginX="2"></RowLayoutColumnInfo>
												</Header>
											</igtbl:UltraGridColumn>
										</Columns>
