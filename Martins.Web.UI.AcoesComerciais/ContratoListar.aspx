...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ContratoListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.ContratoListar" %>
				...
				<TR>
					...
					<TD class="barra1" width="126" height="19">
						<asp:DropDownList id="cmbCriterio" runat="server" Width="150px" Height="19px" Font-Size="11px" Font-Names="Arial"
							...
							<asp:ListItem Value="1" Selected="True">CONTRATO</asp:ListItem>
							<asp:ListItem Value="2">FORNECEDOR</asp:ListItem>
						</asp:DropDownList></TD>
					<TD class="barra1" height="19" vAlign="top" align="left">
						<igtxt:WebNumericEdit id="txtCodigo" runat="server" Width="60px" CssClass="" Font-Names="Arial" Font-Size="11px"></igtxt:WebNumericEdit>
						<uc1:wucFornecedor id="ucFornecedor" runat="server" Visible="False"></uc1:wucFornecedor></TD>
				</TR>
