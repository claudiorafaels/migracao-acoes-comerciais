...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RelacaoEmpenhoTipoPedidoCompra.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.RelacaoEmpenhoTipoPedidoCompra" %>
					...
					<tr>
						<td class="darkbox" vAlign="top">
							...
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									<TR>
										<TD class="barra3" style="WIDTH: 55px; HEIGHT: 45px">Tipo Pedido Compra:</TD>
										<TD class="barra1" style="HEIGHT: 45px" colSpan="3"><asp:dropdownlist id="cmbTipoPedidoCompra" runat="server" Font-Names="Arial" CssClass="" Font-Size="11px"
												Width="250px" Height="19px"></asp:dropdownlist></TD>
									</TR>
									<TR>
										<TD class="barra3" style="WIDTH: 55px; HEIGHT: 22px">Empenho:</TD>
										<TD class="barra1" style="HEIGHT: 22px" colSpan="3">
