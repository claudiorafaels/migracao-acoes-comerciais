...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RelacionamentoTransferenciaVerbaListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.RelacionamentoTransferenciaVerbaListar" %>
			...
			<TABLE class="tabela1" id="Table1" height="8" cellSpacing="0" cellPadding="0" width="100%"
				...
				<TR>
					...
					<TD class="barra1" width="126" height="19"><asp:dropdownlist id="cmbCriterio" runat="server" AutoPostBack="True" Font-Names="Arial" Font-Size="11px"
							Height="19px" Width="210px" CssClass="">
							<asp:ListItem Value="2">RELACIONADO C/FORNECEDOR</asp:ListItem>
							<asp:ListItem Value="1" Selected="True">RELACIONADO C/DIVIS&#195;O COMPRA</asp:ListItem>
						</asp:dropdownlist></TD>
					<TD class="barra1" vAlign="top" align="left" height="19"><asp:dropdownlist id="cmbCelula" runat="server" Font-Names="Arial" Font-Size="11px" Height="19px"
							Width="200px" CssClass=""></asp:dropdownlist>
