<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TipoRelacionamentoListargrid.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.TipoRelacionamentoListarGrid" %>
			...
			<form id="Form1" method="post" runat="server">
				<asp:datagrid id="dtgListar" runat="server" Width="800px" Font-Size="X-Small" AutoGenerateColumns="False"
					...
					<Columns>
						...
						<asp:BoundColumn DataField="TipRlcCttFrn" SortExpression="TipRlcCttFrn" HeaderText="CODIGO">
							<HeaderStyle HorizontalAlign="Right" Width="80px"></HeaderStyle>
							<ItemStyle HorizontalAlign="Right"></ItemStyle>
						</asp:BoundColumn>
						<asp:BoundColumn DataField="DesTipRlcCttFrn" SortExpression="DesTipRlcCttFrn" HeaderText="DESCRI&#199;&#195;O"></asp:BoundColumn>
					</Columns>
