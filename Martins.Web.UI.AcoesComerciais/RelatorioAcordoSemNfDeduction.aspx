...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RelatorioAcordoSemNfDeduction.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.RelatorioAcordoSemNfDeduction" %>
							...
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									<TR>
										...
										<TD class="barra1" colSpan="3"><asp:dropdownlist id="cmbCelula" runat="server" Font-Names="Arial" AutoPostBack="True" Font-Size="11px"
												CssClass="" Height="19px" Width="250px"></asp:dropdownlist></TD>
									</TR>
									<TR>
										<TD class="barra3" style="HEIGHT: 23px">Fornecedor:</TD>
										<TD class="barra1" style="HEIGHT: 23px" colSpan="3"><uc1:wucfornecedor id="ucFornecedor" runat="server"></uc1:wucfornecedor></TD>
									</TR>
									<TR>
										<TD class="barra3">Frm. de Pagto:</TD>
										<TD class="barra1" colSpan="3"><asp:dropdownlist id="cmbFormaPagamento" runat="server" Font-Names="Arial" AutoPostBack="True" Font-Size="11px"
												CssClass="" Height="19px" Width="250px"></asp:dropdownlist></TD>
									</TR>
									<TR>
									</TR>
