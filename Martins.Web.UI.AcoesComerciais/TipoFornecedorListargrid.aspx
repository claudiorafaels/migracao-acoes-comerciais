<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TipoFornecedorListarGrid.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.TipoFornecedorListarGrid" %>
			...
			<form id="Form1" method="post" runat="server">
				<asp:datagrid id="dtgListar" runat="server" Width="800px" Font-Size="X-Small" AutoGenerateColumns="False"
					...
					<Columns>
						...
						<asp:BoundColumn DataField="TIPFRNCTTFRN" SortExpression="TipFrnCttFrn" HeaderText="CODIGO">
							<HeaderStyle HorizontalAlign="Right" Width="80px"></HeaderStyle>
							<ItemStyle HorizontalAlign="Right"></ItemStyle>
						</asp:BoundColumn>
						<asp:BoundColumn DataField="DESTIPFRNCTTFRN" SortExpression="DesTipFrnCttFrn" HeaderText="DESCRI&#199;&#195;O"></asp:BoundColumn>
					</Columns>
