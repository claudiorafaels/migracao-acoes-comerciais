<%@ Page Language="vb" AutoEventWireup="false" Codebehind="UnidadePagamento.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.UnidadePagamento" %>
										...
										<table class="3D" cellSpacing="0" cellPadding="0" border="0">
											<tr>
												<td onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');"><asp:linkbutton id="btnCancelar" style="TEXT-DECORATION: none" runat="server" CausesValidation="False"
														href="UnidadePagamentoListar.aspx"><IMG height="16" src="../Imagens/office/Sair.gif" width="16" align="absMiddle"> Sair</asp:linkbutton></td>
											</tr>
										</table>
									</td>
									<td>
								...
								<TBODY>
									<TR>
										...
										<TD class="barra1" colSpan="3">
											<igtxt:webnumericedit id="txtTipUndPgtCttFrn" runat="server" ReadOnly="True" Font-Names="Arial" Font-Size="11px"
												CssClass="" Width="70px" Height="19px" Enabled="False"></igtxt:webnumericedit></TD>
									</TR>
									<TR>
										<TD class="barra3">Descrição:</TD>
										<TD class="barra1" colSpan="3"><igtxt:webtextedit id="txtDesTipUndPgtCttFrn" runat="server" Height="19px" Width="300px" CssClass=" "
