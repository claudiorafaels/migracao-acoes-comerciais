<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TipoFormaPagamentoListargrid.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.TipoFormaPagamentoListarGrid" %>
			...
			<form id="Form1" method="post" runat="server">
				<asp:datagrid id="dtgListar" runat="server" Width="800px" Font-Size="X-Small" AutoGenerateColumns="False"
					...
					<Columns>
						...
						<asp:BoundColumn DataField="TipFrmPgtCttFrn" SortExpression="TipFrmPgtCttFrn" HeaderText="CODIGO">
							<HeaderStyle HorizontalAlign="Right" Width="80px"></HeaderStyle>
							<ItemStyle HorizontalAlign="Right"></ItemStyle>
						</asp:BoundColumn>
						<asp:BoundColumn DataField="DesTipFrmPgtCttFrn" SortExpression="DesTipFrmPgtCttFrn" HeaderText="DESCRI&#199;&#195;O"></asp:BoundColumn>
					</Columns>
