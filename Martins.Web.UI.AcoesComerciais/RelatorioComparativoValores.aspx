...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RelatorioComparativoValores.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.RelatorioComparativoValores" %>
									...
									<td>
										<table class="3D" cellSpacing="0" cellPadding="0" border="0">
											<tr>
												...
												<td onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');"><asp:linkbutton id="Linkbutton1" style="TEXT-DECORATION: none" runat="server" CausesValidation="False"
							...
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									<TR>
										...
										<TD class="barra1" colSpan="3"><asp:radiobuttonlist id="rdlRelatorio" runat="server" AutoPostBack="True" ForeColor="Black" Width="100%"
												CssClass="">
									...
									<TR>
										<TD class="barra3" style="HEIGHT: 39px">Fornecedor:</TD>
										<TD class="barra1" style="HEIGHT: 39px" colSpan="3"><uc1:wucfornecedor id="ucFornecedor" runat="server"></uc1:wucfornecedor></TD>
									</TR>
									<TR>
										<TD class="barra3" style="HEIGHT: 31px">Contrato:</TD>
										<TD class="barra1" style="HEIGHT: 31px" colSpan="3"><asp:dropdownlist id="cmbContrato" runat="server" AutoPostBack="True" Width="104px" CssClass="" Font-Size="11px"
												Font-Names="Arial" Height="19px"></asp:dropdownlist></TD>
									</TR>
									<TR>
										<TD class="barra3">Opções:</TD>
										<TD class="barra1" colSpan="3">
											<table class="tabela1" cellSpacing="0" cellPadding="2" border="0">
												<tr>
													<td style="WIDTH: 197px"><asp:checkboxlist id="cblOpcoes" runat="server" ForeColor="Black" Width="190px" AutoPostBack="True">
															<asp:ListItem Value="1" Selected="True">Mostrar Somente Diverg&#234;ncias</asp:ListItem>
															<asp:ListItem Value="2">Apresentar Devolu&#231;&#227;o 99</asp:ListItem>
														</asp:checkboxlist>
													</td>
													<TD>
														<table class="3D" cellSpacing="0" cellPadding="0" border="0">
															<tr id="TRImprimir" runat="server">
																<td onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');">
																	<asp:linkbutton id="btnImpNotasPeriodo" style="TEXT-DECORATION: none" runat="server" CausesValidation="False"><IMG height="16" src="../Imagens/office/imprimir.gif" width="16" align="absMiddle">  Imprimir Notas Período</asp:linkbutton>
																</td>
															</tr>
															<tr>
															</tr>
															<tr id="TRExportar" runat="server">
																<td onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');">
																	<asp:linkbutton id="btnExpNotasPeriodo" style="TEXT-DECORATION: none" runat="server" CausesValidation="False"><IMG height="16" src="../Imagens/office/S_F_NXTO.gif" width="16" align="absMiddle">  Exportar Notas Período</asp:linkbutton>
																</td>
															</tr>
														</table>
													</TD>
									...
									<TR id="trClausula" runat="server">
										<TD class="barra3" style="HEIGHT: 17px">Cláusula:</TD>
										<TD class="barra1" style="HEIGHT: 17px" colSpan="3">
											<asp:TextBox id="txtClausula" runat="server" Width="104px" Font-Size="11px" Font-Names="Arial"
												ForeColor="Gray" Height="19px"></asp:TextBox>
											<asp:dropdownlist id="cmbClausula" runat="server" AutoPostBack="True" Width="247px" CssClass="" Font-Size="11px"
												Font-Names="Arial" Height="19px"></asp:dropdownlist></TD>
									</TR>
									<TR id="trMesReferencia" runat="server">
										<TD class="barra3">Data&nbsp;Referência:</TD>
										<TD class="barra1" colSpan="3"><asp:dropdownlist id="cmbMesReferencia" runat="server" AutoPostBack="True" Width="104px" CssClass=""
												Font-Size="11px" Font-Names="Arial" Height="19px"></asp:dropdownlist></TD>
									</TR>
									<TR>
									</TR>
								</TBODY>
