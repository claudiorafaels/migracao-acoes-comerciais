...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ucCancelarPerdaAcordoAtivo.ascx.vb" Inherits="Martins.Web.UI.AcoesComerciais.ucCancelarPerdaAcordoAtivo" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
							...
							<igtbl:UltraGridBand AddButtonCaption="T0118066" SelectTypeRow="Single" Key="T0118066" AllowDelete="Yes">
								<Columns>
									<igtbl:UltraGridColumn HeaderText="FORNECEDOR" Key="" BaseColumnName="">
										<Footer Key=""></Footer>
										<Header Key="" Caption="FORNECEDOR"></Header>
									</igtbl:UltraGridColumn>
									<igtbl:UltraGridColumn HeaderText="CONTRATO" Key="" BaseColumnName="">
										<Footer Key="">
											<RowLayoutColumnInfo OriginX="1"></RowLayoutColumnInfo>
										</Footer>
										<Header Key="" Caption="CONTRATO">
											<RowLayoutColumnInfo OriginX="1"></RowLayoutColumnInfo>
										</Header>
									</igtbl:UltraGridColumn>
									<igtbl:UltraGridColumn HeaderText="CL&#193;USULA" Key="" BaseColumnName="">
										<Footer Key="">
											<RowLayoutColumnInfo OriginX="2"></RowLayoutColumnInfo>
										</Footer>
										<Header Key="" Caption="CL&#193;USULA">
											<RowLayoutColumnInfo OriginX="2"></RowLayoutColumnInfo>
										</Header>
									</igtbl:UltraGridColumn>
									<igtbl:UltraGridColumn HeaderText="PER&#205;ODO" Key="" BaseColumnName="">
										<Footer Key="">
											<RowLayoutColumnInfo OriginX="3"></RowLayoutColumnInfo>
										</Footer>
										<Header Key="" Caption="PER&#205;ODO">
											<RowLayoutColumnInfo OriginX="3"></RowLayoutColumnInfo>
										</Header>
									</igtbl:UltraGridColumn>
									...
									<igtbl:UltraGridColumn HeaderText="ENTIDADE" Key="" BaseColumnName="">
										<Footer Key="">
											<RowLayoutColumnInfo OriginX="5"></RowLayoutColumnInfo>
										</Footer>
										<Header Key="" Caption="ENTIDADE">
											<RowLayoutColumnInfo OriginX="5"></RowLayoutColumnInfo>
										</Header>
									</igtbl:UltraGridColumn>
									...
									<igtbl:UltraGridColumn HeaderText="DATA REFENCIA" Key="" BaseColumnName="">
										<Footer Key="">
											<RowLayoutColumnInfo OriginX="7"></RowLayoutColumnInfo>
										</Footer>
										<Header Key="" Caption="DATA REFENCIA">
											<RowLayoutColumnInfo OriginX="7"></RowLayoutColumnInfo>
										</Header>
									</igtbl:UltraGridColumn>
									...
									<igtbl:UltraGridColumn HeaderText="VALOR DESTINO DA PERDA" Key="" BaseColumnName="">
										<Footer Key="">
											<RowLayoutColumnInfo OriginX="10"></RowLayoutColumnInfo>
										</Footer>
										<Header Key="" Caption="VALOR DESTINO DA PERDA">
											<RowLayoutColumnInfo OriginX="10"></RowLayoutColumnInfo>
										</Header>
									</igtbl:UltraGridColumn>
								</Columns>
