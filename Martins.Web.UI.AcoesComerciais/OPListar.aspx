...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="OPListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.OPListar" %>
...
<HTML>
	<HEAD>
		...
		<META http-equiv="Content-Type" content="text/html; OParset=iso-8859-1">
			...
			<TABLE class="tabela1" id="Table1" height="8" cellSpacing="0" cellPadding="0" width="100%"
				...
				<TR>
					...
					<TD class="barra1" width="126" height="19">
						<asp:DropDownList id="cmbCriterio" runat="server" Width="150px" Height="19px" Font-Size="11px" Font-Names="Arial"
							AutoPostBack="True" CssClass="">
							<asp:ListItem Value="1">PER&#205;ODO RECEBIMENTO</asp:ListItem>
							<asp:ListItem Value="2" Selected="True">DATA RECEBIMENTO</asp:ListItem>
							<asp:ListItem Value="3">PER&#205;ODO/FORNECEDOR</asp:ListItem>
							<asp:ListItem Value="4">N&#218;MERO</asp:ListItem>
						</asp:DropDownList></TD>
					<TD class="barra1" height="19" vAlign="top" align="left">
						<igtxt:WebDateTimeEdit id="txtDataInicial" runat="server" Width="70px" Height="19px" Font-Size="11px" Font-Names="Arial"
							CssClass=""></igtxt:WebDateTimeEdit>
						<asp:Label id="LblA" runat="server" Visible="False">A</asp:Label>
						<igtxt:WebDateTimeEdit id="txtDataFinal" runat="server" Width="70px" Height="19px" Font-Size="11px" Font-Names="Arial"
							Visible="False" CssClass=""></igtxt:WebDateTimeEdit>
						<asp:Label id="LblFornecedor" runat="server" Visible="False">Fornecedor</asp:Label>
						<igtxt1:WebNumericEdit id="txtCodigo" runat="server" CssClass="" Width="60px" AutoPostBack="True"
							Font-Names="Arial" Font-Size="11px" Visible="False"></igtxt1:WebNumericEdit>
						<asp:DropDownList id="cmbNomeFornecedor" runat="server" AutoPostBack="True" Font-Names="Arial" Font-Size="11px"
							Height="19px" Width="170px" Visible="False" CssClass=""></asp:DropDownList>
						<igtxt:WebTextEdit id="txtNomeFornecedor" runat="server" Font-Names="Arial" Font-Size="11px" Width="170px"
							CssClass="" Visible="False"></igtxt:WebTextEdit>
