...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ParametroFornecedorMmm.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.ParametroFornecedorMmm" %>
								...
								<TBODY>
									<TR>
										...
										<TD class="barra1" colSpan="3">
											<uc1:wucFornecedor id="wucCODFRN" runat="server"></uc1:wucFornecedor></TD>
									</TR>
									<TR>
										<TD class="barra3">Possui Contrato:</TD>
										<TD class="barra1" colSpan="3">
											<asp:RadioButtonList id="rblFLGFRNAJTCMC" runat="server" Font-Size="11px" Font-Names="Arial">
