...
#End Region
    ...
    Private Sub btnInserir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnInserir.Click
        Controller.NavegarInserirBanco()
    End Sub
    ...
    Private Sub btnPesquisar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPesquisar.Click
        Try
            ...
            If Me.cmbCriterio.SelectedValue = "0" Then      'NENHUM
                lblFrame.Text = "<iframe src='" & "BancoListarGrid.aspx?criterio=" & cmbCriterio.SelectedItem.Value & "' height=100% width=100% frameborder=0 ALLOWTRANSPARENCY scrolling=yes></iframe>"
            ElseIf Me.cmbCriterio.SelectedValue = "1" Then  'Consulta por CÓDIGO
                If Not IsNumeric(txtCODFRN.Text) Then
                    ...
                    Exit Try
                End If
                lblFrame.Text = "<iframe src='" & "BancoListarGrid.aspx?criterio=" & cmbCriterio.SelectedItem.Value & "&CodBco=" & txtCODFRN.Text & "' height=100% width=100% frameborder=0 ALLOWTRANSPARENCY scrolling=yes></iframe>"
            ElseIf cmbCriterio.SelectedValue = "2" Then 'Consulta por Nome
                If txtNome.Text.Trim.Length < 3 Then
                    ...
                    Exit Try
                End If
                lblFrame.Text = "<iframe src='" & "BancoListarGrid.aspx?criterio=" & cmbCriterio.SelectedItem.Value & "&NomBco=" & txtNome.Text & "' height=100% width=100% frameborder=0 ALLOWTRANSPARENCY scrolling=yes></iframe>"
            End If
    ...
    Private Sub cmbCriterio_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbCriterio.SelectedIndexChanged
        ...
        If cmbCriterio.SelectedValue = "0" Then
            'Não mostra nada
        ElseIf cmbCriterio.SelectedValue = "1" Then
    ...
    Private Sub RestaurarCriteriosDePesquisa(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not Session("BancoListar") Is Nothing Then
            Try
                criterios = CType(Session("BancoListar"), Collection)
                ...
                txtCODFRN.Text = CType(criterios.Item("txtCODFRN"), String)
