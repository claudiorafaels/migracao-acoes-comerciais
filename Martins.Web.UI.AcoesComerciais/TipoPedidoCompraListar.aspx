...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TipoPedidoCompraListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.TipoPedidoCompraListar" %>
			...
			<TABLE class="tabela1" id="Table1" height="8" cellSpacing="0" cellPadding="0" width="100%"
				...
				<TR>
					...
					<TD class="barra1" height="19" vAlign="top" align="left">
						<igtxt1:WebNumericEdit id="txtCodigo" runat="server" Height="19px" Width="70px" CssClass="" Visible="False"
