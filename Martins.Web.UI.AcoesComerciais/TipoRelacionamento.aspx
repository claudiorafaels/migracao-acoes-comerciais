...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TipoRelacionamento.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.TipoRelacionamento" %>
							...
							<table cellSpacing="0" cellPadding="0" border="0" id="tbOpcoes" runat="server">
								<tr>
									...
									<td>
										<table class="3D" cellSpacing="0" cellPadding="0" border="0">
											<tr>
												<td onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');"><asp:linkbutton id="btnCancelar" style="TEXT-DECORATION: none" runat="server" href="TipoRelacionamentoListar.aspx"
							...
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									<TR>
										...
										<TD class="barra1" colSpan="3"><igtxt:webnumericedit id="txtTipRlcCttFrn" runat="server" ReadOnly="True" Font-Names="Arial" Font-Size="11px"
												CssClass="" Width="70px" Height="19px"></igtxt:webnumericedit></TD>
									</TR>
									<TR>
										<TD class="barra3">Descrição:</TD>
										<TD class="barra1" colSpan="3">
											<igtxt:webtextedit id="txtDesTipRlcCttFrn" runat="server" Height="19px" Width="300px" CssClass=" "
