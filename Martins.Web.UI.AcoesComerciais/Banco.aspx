...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Banco.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.Banco" %>
										...
										<table class="3D" cellSpacing="0" cellPadding="0" border="0">
											<tr>
												<td onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');"><asp:linkbutton id="btnCancelar" style="TEXT-DECORATION: none" runat="server" CausesValidation="False"
														href="BancoListar.aspx"><IMG height="16" src="../Imagens/office/Sair.gif" width="16" align="absMiddle"> Sair</asp:linkbutton></td>
											</tr>
										</table>
									</td>
									<td>
								...
								<TBODY>
									<TR>
										...
										<TD class="barra1" colSpan="3">
											<igtxt:WebNumericEdit id="txtCODBCO" runat="server" Height="19px" Width="50px" CssClass=" " Font-Size="11px"
												Font-Names="Arial"></igtxt:WebNumericEdit></TD>
									</TR>
									<TR>
										<TD class="barra3">Nome:</TD>
										<TD class="barra1" colSpan="3">
											<igtxt:WebTextEdit id="txtNOMBCO" runat="server" Height="19px" Width="250px" CssClass=" " Font-Size="11px"
												Font-Names="Arial"></igtxt:WebTextEdit></TD>
									</TR>
									<TR>
										<TD class="barra3">CNPJ:</TD>
										<TD class="barra1" colSpan="3">
											<igtxt:WebTextEdit id="txtNUMCGCBCO" runat="server" Width="180px" Height="19px" CssClass=" "
												Font-Size="11px" Font-Names="Arial"></igtxt:WebTextEdit></TD>
									</TR>
									<TR>
									</TR>
								</TBODY>
