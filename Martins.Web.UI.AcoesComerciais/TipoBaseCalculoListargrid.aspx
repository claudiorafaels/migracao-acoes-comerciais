<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TipoBaseCalculoListargrid.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.TipoBaseCalculoListarGrid" %>
		...
		<P>
			<form id="Form1" method="post" runat="server">
				<asp:datagrid id="dtgListar" runat="server" Width="800px" Font-Size="X-Small" AutoGenerateColumns="False"
					CssClass=" " DataKeyField="TIPBSECAL" PageSize="20" AllowPaging="True">
					...
					<Columns>
						...
						<asp:BoundColumn DataField="TIPBSECAL" SortExpression="TIPBSECAL" HeaderText="CODIGO">
							<HeaderStyle HorizontalAlign="Right" Width="70px"></HeaderStyle>
							<ItemStyle HorizontalAlign="Right"></ItemStyle>
						</asp:BoundColumn>
						<asp:BoundColumn DataField="DESBSECAL" SortExpression="DESBSECAL" HeaderText="DESCRI&#199;&#195;O"></asp:BoundColumn>
					</Columns>
