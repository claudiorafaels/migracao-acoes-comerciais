...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents txtDESMTVAPVFLUACOCMC As System.Web.UI.WebControls.TextBox
...
#Region "Metodo Carga"
    ...
    Private Sub IniciarPagina()
        Try
            AtualizaTela()
            Util.AdicionaJsFocus(Me.Page, txtDESMTVAPVFLUACOCMC)
        Catch ex As Exception
            Controller.TrataErro(Me.Page, ex)
        End Try
    End Sub
...
#Region "Regra"
    ...
    Private Sub AprovarFluxo()
        ...
        Controller.AprovarFluxoTransferenciaVerbas(WSCAcoesComerciais.numFluApv, CODFNC, txtDESMTVAPVFLUACOCMC.Text)
    End Sub

    Private Sub ReprovarFluxo()
        Dim CODFNC As Decimal
        CODFNC = Controller.ObterFuncionarioLogadoSistema
        Controller.ReprovarFluxoTransferenciaVerbas(WSCAcoesComerciais.numFluApv, CODFNC, txtDESMTVAPVFLUACOCMC.Text)
    End Sub
#End Region
