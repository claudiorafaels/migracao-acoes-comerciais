...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="EmpenhoFornecedorListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.EmpenhoFornecedorListar" %>
<%@ Register TagPrefix="igtbl" Namespace="Infragistics.WebUI.UltraWebGrid" Assembly="Infragistics.WebUI.UltraWebGrid.v5.3, Version=5.3.20053.50, Culture=neutral, PublicKeyToken=7dd5c3163f2cd0cb" %>
	...
	<BODY onload="MM_preloadImages('../../Imagens/lastpost.gif')">
		<form id="Form1" runat="server">
			...
			<TABLE class="tabela3" id="Table3" height="8" cellSpacing="0" cellPadding="0" width="100%"
				border="0">
				<TR>
					<TD width="100%" colSpan="7" height="6"></TD>
				</TR>
				<TR>
				...
				<TR id="TRStatus" runat="server">
					...
					<TD class="barra1" width="90%" colSpan="6" height="19"><asp:dropdownlist id="cmbStatus" runat="server" Width="130px">
							<asp:ListItem Value="0">Novo</asp:ListItem>
							<asp:ListItem Value="1" Selected="True">Em aprova&#231;&#227;o</asp:ListItem>
			...
			<TABLE class="tabela3" id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					<TD class="barra1" width="100%" colSpan="7" height="19"><igtbl:ultrawebgrid id=GrdFluxo runat="server" Width="100%" Height="440px" ImageDirectory="/ig_common/Images/" DataSource="<%# DatasetTransferenciaVerbaFornecedor1 %>" DataMember="CADTRNVBAFRNJOIN">
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White">
							...
							<Bands>
								<igtbl:UltraGridBand AddButtonCaption="CADTRNVBAFRNJOIN" BaseTableName="CADTRNVBAFRNJOIN" Key="CADTRNVBAFRNJOIN"
									DataKeyField="CODATI,CODGRPMERNCM">
									<Columns>
										...
										<igtbl:UltraGridColumn HeaderText="Fluxo" Key="NUMFLUAPV" IsBound="True" Width="60px" DataType="System.Decimal"
											BaseColumnName="NUMFLUAPV">
											<Footer Key="NUMFLUAPV">
												<RowLayoutColumnInfo OriginX="1"></RowLayoutColumnInfo>
											</Footer>
											<Header Key="NUMFLUAPV" Caption="Fluxo">
												<RowLayoutColumnInfo OriginX="1"></RowLayoutColumnInfo>
											</Header>
										</igtbl:UltraGridColumn>
										<igtbl:UltraGridColumn HeaderText="Status Fluxo" Key="TIPSTAFLUAPV" IsBound="True" Hidden="True" BaseColumnName="TIPSTAFLUAPV">
											<Footer Key="TIPSTAFLUAPV">
												<RowLayoutColumnInfo OriginX="2"></RowLayoutColumnInfo>
											</Footer>
											<Header Key="TIPSTAFLUAPV" Caption="Status Fluxo">
												<RowLayoutColumnInfo OriginX="2"></RowLayoutColumnInfo>
											</Header>
										</igtbl:UltraGridColumn>
										<igtbl:UltraGridColumn HeaderText="Status Fluxo" Key="DESSTAFLUAPV" IsBound="True" BaseColumnName="DESSTAFLUAPV">
											<Footer Key="DESSTAFLUAPV">
												<RowLayoutColumnInfo OriginX="3"></RowLayoutColumnInfo>
											</Footer>
											<Header Key="DESSTAFLUAPV" Caption="Status Fluxo">
												<RowLayoutColumnInfo OriginX="3"></RowLayoutColumnInfo>
											</Header>
										</igtbl:UltraGridColumn>
										<igtbl:UltraGridColumn HeaderText="Descri&#231;&#227;o Aloca&#231;&#227;o" Key="DESALCVBAFRN" IsBound="True"
											Width="120px" Hidden="True" BaseColumnName="DESALCVBAFRN">
											<Footer Key="DESALCVBAFRN">
												<RowLayoutColumnInfo OriginX="4"></RowLayoutColumnInfo>
											</Footer>
											<Header Key="DESALCVBAFRN" Caption="Descri&#231;&#227;o Aloca&#231;&#227;o">
												<RowLayoutColumnInfo OriginX="4"></RowLayoutColumnInfo>
											</Header>
										</igtbl:UltraGridColumn>
										<igtbl:UltraGridColumn HeaderText="Descri&#231;&#227;o Destino" Key="DESDSNDSCBNF" IsBound="True" Width="120px"
											BaseColumnName="DESDSNDSCBNF">
											<Footer Key="DESDSNDSCBNF">
												<RowLayoutColumnInfo OriginX="5"></RowLayoutColumnInfo>
											</Footer>
											<Header Key="DESDSNDSCBNF" Caption="Descri&#231;&#227;o Destino">
												<RowLayoutColumnInfo OriginX="5"></RowLayoutColumnInfo>
											</Header>
										</igtbl:UltraGridColumn>
										<igtbl:UltraGridColumn HeaderText="Descri&#231;&#227;o Justificativa" Key="DESJSTTRNVBA" IsBound="True"
											Width="200px" BaseColumnName="DESJSTTRNVBA">
											<Footer Key="DESJSTTRNVBA">
												<RowLayoutColumnInfo OriginX="6"></RowLayoutColumnInfo>
											</Footer>
											<Header Key="DESJSTTRNVBA" Caption="Descri&#231;&#227;o Justificativa">
												<RowLayoutColumnInfo OriginX="6"></RowLayoutColumnInfo>
											</Header>
										</igtbl:UltraGridColumn>
										<igtbl:UltraGridColumn HeaderText="Funcionario" Key="NOMFNC" IsBound="True" Width="150px" BaseColumnName="NOMFNC">
											<Footer Key="NOMFNC">
												<RowLayoutColumnInfo OriginX="7"></RowLayoutColumnInfo>
											</Footer>
											<Header Key="NOMFNC" Caption="Funcionario">
												<RowLayoutColumnInfo OriginX="7"></RowLayoutColumnInfo>
											</Header>
										</igtbl:UltraGridColumn>
									</Columns>
