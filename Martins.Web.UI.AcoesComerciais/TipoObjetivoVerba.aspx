<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TipoObjetivoVerba.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.TipoObjetivoVerba" %>
								...
								<tr>
									<td>
										<table class="3D" border="0" cellSpacing="0" cellPadding="0">
											<tr>
												<td onmouseover="mOvr(this,'#E1EBF4');" onmouseout="mOut(this,'');" onclick="mClk('#');"><asp:linkbutton style="TEXT-DECORATION: none" id="btnSalvar" runat="server"><IMG height="16" src="../Imagens/office/salvar.gif" width="16" align="absMiddle"> Salvar</asp:linkbutton></td>
											</tr>
										</table>
									</td>
									<td>
										<table class="3D" border="0" cellSpacing="0" cellPadding="0">
											<tr>
												<td onmouseover="mOvr(this,'#E1EBF4');" onmouseout="mOut(this,'');" onclick="mClk('#');"><asp:linkbutton style="TEXT-DECORATION: none" id="btnCancelar" runat="server" CausesValidation="False"
														href="TipoObjetivoVerbaListar.aspx"><IMG height="16" src="../Imagens/office/Sair.gif" width="16" align="absMiddle"> Sair</asp:linkbutton></td>
											</tr>
										</table>
									</td>
									<td>
										<table class="3D" border="0" cellSpacing="0" cellPadding="0">
											<tr>
												<td onmouseover="mOvr(this,'#E1EBF4');" onmouseout="mOut(this,'');" onclick="mClk('#');"><asp:linkbutton style="TEXT-DECORATION: none" id="btnApagar" runat="server" CausesValidation="False"
														Visible="False"><IMG height="16" src="../Imagens/office/S_B_COLR.gif"" width="16" align="absMiddle">
													Desativar</asp:linkbutton></td>
											</tr>
										</table>
									</td>
									<td>
							...
							<TABLE id="Table1" class="tabela1" border="0" cellSpacing="0" cellPadding="2" width="100%">
								<TBODY>
									<TR>
										...
										<TD class="barra1" colSpan="3"><igtxt:webnumericedit id="txtTipAbgTabPcoCttFrn" runat="server" Enabled="False" Height="19px" Width="70px"
												CssClass="" Font-Size="11px" Font-Names="Arial" ReadOnly="True"></igtxt:webnumericedit></TD>
									</TR>
									<TR>
										<TD class="barra3">Descrição:</TD>
										<TD class="barra1" colSpan="3"><igtxt:webtextedit id="txtDesTipAbgTabPcoCtt" runat="server" Height="19px" Width="250px" CssClass=""
												Font-Size="11px" Font-Names="Arial" MaxLength="30"></igtxt:webtextedit></TD>
									</TR>
									<TR>
									</TR>
								</TBODY>
