Public Class FormaPagamentoListar
...
#End Region
    ...
    Private Sub btnInserir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnInserir.Click
        Controller.NavegarInserirFormaPagamento()
    End Sub
    ...
    Private Sub btnPesquisar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPesquisar.Click
        Try
            ...
            If Me.cmbCriterio.SelectedValue = "0" Then  'NENHUM
                lblFrame.Text = "<iframe src='" & "FormaPagamentoListarGrid.aspx?criterio=" & cmbCriterio.SelectedItem.Value & "' height=100% width=100% frameborder=0 ALLOWTRANSPARENCY scrolling=yes></iframe>"
            ElseIf Me.cmbCriterio.SelectedValue = "1" Then  'Consulta por CÓDIGO
                If Not IsNumeric(txtCODFRN.Text) Then
                    ...
                    Exit Try
                End If
                lblFrame.Text = "<iframe src='" & "FormaPagamentoListarGrid.aspx?criterio=" & cmbCriterio.SelectedItem.Value & "&TipFrmDscBnf=" & txtCODFRN.Text & "' height=100% width=100% frameborder=0 ALLOWTRANSPARENCY scrolling=yes></iframe>"
            ElseIf cmbCriterio.SelectedValue = "2" Then 'Consulta por DESCRIÇÃO
                If txtDescricao.Text.Trim.Length < 3 Then
                    ...
                    Exit Try
                End If
                lblFrame.Text = "<iframe src='" & "FormaPagamentoListarGrid.aspx?criterio=" & cmbCriterio.SelectedItem.Value & "&DesFrmDscBnf=" & txtDescricao.Text & "' height=100% width=100% frameborder=0 ALLOWTRANSPARENCY scrolling=yes></iframe>"
            End If
    ...
    Private Sub GravarCriteriosDePesquisa(ByVal urlFrame As String)
        ...
        End With
        Session("FormaPagamentoListar") = criterios
    End Sub
    ...
    Private Sub RestaurarCriteriosDePesquisa(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not Session("FormaPagamentoListar") Is Nothing Then
            Try
                criterios = CType(Session("FormaPagamentoListar"), Collection)
