...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RelacaoUsuarioCelulaListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.RelacaoUsuarioCelulaListar" %>
	...
	<BODY onload="MM_preloadImages('../Imagens/lastpost.gif')">
		<form id="Form1" runat="server">
			...
			<TABLE class="tabela1" id="Table1" height="8" cellSpacing="0" cellPadding="0" width="100%"
				border="0">
				<TR>
					<TD class="barra3" height="14" widTD="10%">Critério:
					</TD>
					<TD class="barra1" width="126" height="14">
						<asp:DropDownList id="cmbCriterio" runat="server" Width="150px" Height="19px" Font-Size="11px" Font-Names="Arial"
							...
							<asp:ListItem Value="1">C&#201;LULA</asp:ListItem>
							<asp:ListItem Value="2" Selected="True">USUARIO</asp:ListItem>
						</asp:DropDownList></TD>
					<TD class="barra1" height="14" vAlign="top" align="left">
						...
						<asp:DropDownList id="cmbCelula" runat="server" Font-Names="Arial" Font-Size="11px" Height="19px"
