...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RelatorioHistoricoAcordo.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.RelatorioHistoricoAcordo" %>
					...
					<tr>
						<td class="darkbox" vAlign="top">
							...
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									<TR>
										<TD class="barra3" style="HEIGHT: 43px">Fornecedor:</TD>
										<TD class="barra1" style="HEIGHT: 43px" colSpan="3"><uc1:wucfornecedor id="ucFornecedor" runat="server"></uc1:wucfornecedor></TD>
									</TR>
									<TR>
										<TD class="barra3">Acordo:</TD>
										<TD class="barra1" colSpan="3">
											<igtxt:WebNumericEdit id="txtAcordo" runat="server" CssClass="" Width="60px" Font-Size="11px" AutoPostBack="True"
												Font-Names="Arial"></igtxt:WebNumericEdit><asp:dropdownlist id="cmbAcordo" runat="server" Height="19px" Font-Names="Arial" AutoPostBack="True"
												Font-Size="11px" Width="80px" CssClass=""></asp:dropdownlist></TD>
									</TR>
									<TR>
										<TD class="barra3">Relatório:</TD>
										<TD class="barra1" colSpan="3">
											<asp:RadioButtonList id="rdbTipoRelatorio" runat="server" Width="244px" RepeatColumns="2">
												<asp:ListItem Value="0" Selected="True">Hist&#243;rico</asp:ListItem>
												<asp:ListItem Value="1">Perdas</asp:ListItem>
