...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ucCancelarPerdaAcordoOperacaoContrato.ascx.vb" Inherits="Martins.Web.UI.AcoesComerciais.ucCancelarPerdaAcordoOperacaoContrato" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
						...
						<Bands>
							<igtbl:UltraGridBand AddButtonCaption="T0118066" SelectTypeRow="Single" Key="T0118066" AllowDelete="Yes">
								<Columns>
									...
									<igtbl:UltraGridColumn HeaderText="NUM. REF. PER&#205;ODO" Key="" BaseColumnName="">
										<Footer Key="">
											<RowLayoutColumnInfo OriginX="3"></RowLayoutColumnInfo>
										</Footer>
										<Header Key="" Caption="NUM. REF. PER&#205;ODO">
											<RowLayoutColumnInfo OriginX="3"></RowLayoutColumnInfo>
										</Header>
									</igtbl:UltraGridColumn>
									...
									<igtbl:UltraGridColumn HeaderText="DAT. REFER&#202;NCIA" Key="" BaseColumnName="">
										<Footer Key="">
											<RowLayoutColumnInfo OriginX="6"></RowLayoutColumnInfo>
										</Footer>
										<Header Key="" Caption="DAT. REFER&#202;NCIA">
											<RowLayoutColumnInfo OriginX="6"></RowLayoutColumnInfo>
										</Header>
									</igtbl:UltraGridColumn>
				...
				<TABLE id="Table3" cellSpacing="0" cellPadding="0" border="0" align="right">
					<TR>
						<TD onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');">
							<asp:linkbutton id="btnSalvar" style="TEXT-DECORATION: none" runat="server"><IMG height="16" src="../Imagens/office/imprimir.gif" width="16" align="absMiddle">  Imprimir Contrato</asp:linkbutton></TD>
						<TD onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');">
