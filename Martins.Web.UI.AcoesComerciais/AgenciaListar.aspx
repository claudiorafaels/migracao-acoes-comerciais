...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AgenciaListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.AgenciaListar" %>
							...
							<table cellSpacing="0" cellPadding="0" border="0">
								<tr>
									...
									<td height="10">
										<table class="3D" cellSpacing="0" cellPadding="0" border="0">
											<tr>
												<td onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');"><asp:linkbutton id="btnInserir" style="TEXT-DECORATION: none" runat="server" Visible="False"><img src="../Imagens/office/novo.gif" width="16" height="16" align="absMiddle">Novo</asp:linkbutton></td>
											</tr>
										</table>
									</td>
								</tr>
				...
				<TR>
					...
					<TD class="barra1" width="126" height="19">
						<asp:DropDownList id="cmbCriterio" runat="server" Width="150px" Height="19px" Font-Size="11px" Font-Names="Arial"
							...
							<asp:ListItem Value="1">CODIGO AGENCIA</asp:ListItem>
							<asp:ListItem Value="2" Selected="True">CODIGO BANCO</asp:ListItem>
							<asp:ListItem Value="3">NOME AGENCIA</asp:ListItem>
						</asp:DropDownList></TD>
					<TD class="barra1" height="19" vAlign="top" align="left">
						<igtxt1:WebNumericEdit id="txtCODFRN" runat="server" Height="19px" Width="60px" Font-Names="Arial" Font-Size="11px"
							CssClass=""></igtxt1:WebNumericEdit>
						<igtxt1:WebTextEdit id="txtNome" runat="server" Height="19px" Width="250px" Visible="False" Font-Names="Arial"
							Font-Size="11px" CssClass=""></igtxt1:WebTextEdit></TD>
				</TR>
