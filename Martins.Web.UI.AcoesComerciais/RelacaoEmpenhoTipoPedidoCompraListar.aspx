...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RelacaoEmpenhoTipoPedidoCompraListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.RelacaoEmpenhoTipoPedidoCompraListar" %>
				...
				<TR>
					...
					<TD class="barra1" width="126" height="19">
						<asp:DropDownList id="cmbCriterio" runat="server" Width="150px" Height="19px" Font-Size="11px" Font-Names="Arial"
							...
							<asp:ListItem Value="1">EMPENHO</asp:ListItem>
							<asp:ListItem Value="2">TIPO PEDIDO COMPRA</asp:ListItem>
						</asp:DropDownList></TD>
					<TD class="barra1" height="19" vAlign="top" align="left">
						<asp:DropDownList id="CmbEmpenho" runat="server" CssClass="" AutoPostBack="True" Font-Names="Arial"
							Font-Size="11px" Height="19px" Width="216px" Visible="False"></asp:DropDownList>
						<asp:DropDownList id="cmbTipoPedidoCompra" runat="server" CssClass="" AutoPostBack="True" Font-Names="Arial"
							Font-Size="11px" Height="19px" Width="216px" Visible="False"></asp:DropDownList></TD>
				</TR>
