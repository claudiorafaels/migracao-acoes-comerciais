Public Class TipoFormaPagamentoListar
...
#End Region
    ...
    Private Sub btnInserir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnInserir.Click
        Controller.NavegarInserirTipoFormaPagamento()
    End Sub
    ...
    Private Sub btnPesquisar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPesquisar.Click
        ...
        Try
            'Verifica o critério
            If Me.cmbCriterio.SelectedValue = "0" Then  'Consulta por Descrição
                lblFrame.Text = "<iframe src='" & "TipoFormaPagamentoListarGrid.aspx?criterio=" & cmbCriterio.SelectedItem.Value & "' height=100% width=100% frameborder=0 ALLOWTRANSPARENCY scrolling=yes></iframe>"
            ElseIf Me.cmbCriterio.SelectedValue = "1" Then  'Consulta por Descrição
                If txtDescricao.Text.Trim.Length < 3 Then
                    ...
                    Exit Try
                End If
                lblFrame.Text = "<iframe src='" & "TipoFormaPagamentoListarGrid.aspx?criterio=" & cmbCriterio.SelectedItem.Value & "&DesTipFrmPgtCttFrn=" & txtDescricao.Text & "' height=100% width=100% frameborder=0 ALLOWTRANSPARENCY scrolling=yes></iframe>"
            ...
            ElseIf cmbCriterio.SelectedValue = "2" Then 'Consulta por Código
                If Not IsNumeric(txtCodigo.Text) Then
                    ...
                    Exit Try
                End If
                lblFrame.Text = "<iframe src='" & "TipoFormaPagamentoListarGrid.aspx?criterio=" & cmbCriterio.SelectedItem.Value & "&TipFrmPgtCttFrn=" & txtCodigo.Text & "' height=100% width=100% frameborder=0 ALLOWTRANSPARENCY scrolling=yes></iframe>"
    ...
    Private Sub GravarCriteriosDePesquisa(ByVal urlFrame As String)
        ...
        End With
        Session("TipoFormaPagamentoListar") = criterios
    End Sub
    ...
    Private Sub RestaurarCriteriosDePesquisa(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not Session("TipoFormaPagamentoListar") Is Nothing Then
            Try
                criterios = CType(Session("TipoFormaPagamentoListar"), Collection)
