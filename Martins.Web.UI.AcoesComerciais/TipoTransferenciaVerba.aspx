...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TipoTransferenciaVerba.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.TipoTransferenciaVerba" %>
										...
										<table class="3D" cellSpacing="0" cellPadding="0" border="0">
											<tr>
												<td onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');"><asp:linkbutton id="btnCancelar" style="TEXT-DECORATION: none" runat="server" CausesValidation="False"
														href="TipoTransferenciaVerbaListar.aspx"><IMG height="16" src="../Imagens/office/Sair.gif" width="16" align="absMiddle"> Sair</asp:linkbutton></td>
											</tr>
										</table>
									</td>
									<td>
								...
								<TBODY>
									<TR>
										...
										<TD class="barra1" colSpan="3">
											<igtxt:WebNumericEdit id="txtCODTIPTRNVLRACOCMC" runat="server" Height="19px" Width="70px" CssClass=""
												Font-Size="11px" Font-Names="Arial" ReadOnly="True"></igtxt:WebNumericEdit></TD>
									</TR>
									<TR>
										<TD class="barra3" style="HEIGHT: 18px">Empenho:</TD>
										<TD class="barra1" colSpan="3" style="HEIGHT: 18px">
											<uc1:wucEmpenho id="ucEmpenho" runat="server"></uc1:wucEmpenho></TD>
									</TR>
									<TR>
										<TD class="barra3">Descrição:</TD>
										<TD class="barra1" colSpan="3">
											<igtxt:WebTextEdit id="txtDESTIPTRNVLRACOCMC" runat="server" Height="19px" Width="250px" CssClass=""
