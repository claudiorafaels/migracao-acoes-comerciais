Public Class TransferenciaVerbasListar
...
#End Region
    ...
    Private Sub btnInserir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnInserir.Click
        Controller.NavegarInserirTransferenciaVerba()
    End Sub
    ...
    Private Sub GravarCriteriosDePesquisa(ByVal urlFrame As String)
        ...
        End With
        Session("TransferenciaVerbaListar") = criterios
    End Sub
    ...
    Private Sub RestaurarCriteriosDePesquisa(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not Session("TransferenciaVerbaListar") Is Nothing Then
            Try
                criterios = CType(Session("TransferenciaVerbaListar"), Collection)
