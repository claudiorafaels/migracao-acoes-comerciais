<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ExtratoCelula.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.ExtratoCelula" %>
...
//-->
	...
	<body onload="MM_preloadImages('../Imagens/lastpost.gif')">
		<form id="Form1" onsubmit="ExibeMensagem();" method="post" runat="server">
					...
					<tr>
						<td class="darkbox" vAlign="top">
							...
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									<TR>
										<TD class="barra3" style="HEIGHT: 51px">Tipo:</TD>
										<TD class="barra1" style="WIDTH: 315px; HEIGHT: 51px" colSpan="3"><asp:radiobuttonlist id="tblOpcao" runat="server" Width="152px" AutoPostBack="True">
												<asp:ListItem Value="0" Selected="True">Sint&#233;tico</asp:ListItem>
												<asp:ListItem Value="1">Anal&#237;tico</asp:ListItem>
											</asp:radiobuttonlist></TD>
									</TR>
									<TR>
										<TD class="barra3" id="TD5" runat="server">Filtro:</TD>
										<TD class="barra1" style="WIDTH: 315px" colSpan="3" id="TD4" runat="server">
											<asp:dropdownlist id="cmbFiltro" runat="server" Width="200px" CssClass="">
												<asp:ListItem Value="1">TODOS</asp:ListItem>
												<asp:ListItem Value="2">SALDO NEGATIVO</asp:ListItem>
											</asp:dropdownlist></TD>
									</TR>
									<TR>
										<TD class="barra3">Célula:</TD>
										<TD class="barra1" style="WIDTH: 315px" colSpan="3"><asp:dropdownlist id="cmbCelula" runat="server" Width="200px" CssClass=""></asp:dropdownlist></TD>
									</TR>
									<TR>
										<TD class="barra3">Mês Referencia:</TD>
										<TD class="barra1" style="WIDTH: 315px" colSpan="3"><igtxt:webdatetimeedit id="txtMesRef" runat="server" Width="80px" CssClass="" DisplayModeFormat="yyyy/MM"
												Font-Size="11px" Font-Names="Arial" EditModeFormat="yyyy/MM"></igtxt:webdatetimeedit></TD>
									</TR>
									<TR>
										<TD class="barra3">Empenho:</TD>
										<TD class="barra1" style="WIDTH: 315px" colSpan="3"><asp:dropdownlist id="cmbEmpenho" runat="server" Width="200px" CssClass=""></asp:dropdownlist></TD>
									</TR>
									<TR>
									</TR>
								</TBODY>
