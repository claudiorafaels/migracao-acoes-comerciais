...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TipoLancamentoListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.TipoLancamentoListar" %>
...
<HTML>
	...
	<BODY onload="MM_preloadImages('../Imagens/lastpost.gif')">
		<form id="Form1" runat="server">
			...
			<TABLE class="tabela1" id="Table1" height="8" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<TR>
					...
					<TD class="barra1" height="19" vAlign="top" align="left">
						...
						<igtxt1:WebNumericEdit id="txtCodigo" runat="server" Height="19px" Width="60px" Font-Names="Arial" Font-Size="11px"
							CssClass=" " Visible="False"></igtxt1:WebNumericEdit></TD>
				</TR>
