...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="OperacoesOPListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.OperacoesOPListar" %>
...
//-->
	...
	<BODY onload="MM_preloadImages('../Imagens/lastpost.gif')">
		<form id="Form1" runat="server">
			...
			<table height="424" cellSpacing="0" cellPadding="0" width="901" border="0">
				<tbody>
					<tr>
					</tr>
				</tbody></table>
			...
			<TABLE class="tabela1" id="Table1" height="8" cellSpacing="0" cellPadding="0" width="900"
				border="0">
				<TR>
					<TD class="barra3" height="19" widTD="10%">Critério:
					</TD>
					<TD class="barra1" width="126" height="19">
						<asp:DropDownList id="cmbCriterio" runat="server" Width="150px" Height="19px" Font-Size="10px" Font-Names="Arial"
							AutoPostBack="True">
					...
					<TD class="barra1" height="19" vAlign="top" align="left">
						<igtxt:WebDateTimeEdit id="txtDataInicial" runat="server" Width="70px" Height="19px" Font-Size="10px" Font-Names="Arial"
							Visible="False" CssClass=""></igtxt:WebDateTimeEdit>
						<asp:Label id="LblA" runat="server" Visible="False">A</asp:Label>
						<igtxt:WebDateTimeEdit id="txtDataFinal" runat="server" Width="70px" Height="19px" Font-Size="10px" Font-Names="Arial"
							Visible="False" CssClass=""></igtxt:WebDateTimeEdit>
						<asp:Label id="LblFornecedor" runat="server" Visible="False">Fornecedor</asp:Label>
						<igtxt1:WebNumericEdit id="txtCodigo" runat="server" Width="60px" DataMode="Decimal" CssClass="" AutoPostBack="True"
							Font-Names="Arial" Font-Size="11px"></igtxt1:WebNumericEdit>
						<asp:DropDownList id="cmbNomeFornecedor" runat="server" Width="170px" Height="19px" Font-Size="10px"
							Font-Names="Arial" Visible="False" CssClass=""></asp:DropDownList>
						<igtxt:webtextedit id="txtNomeFornecedor" runat="server" Font-Names="Arial" Font-Size="11px" Width="170px"
							Visible="False" CssClass=""></igtxt:webtextedit>
