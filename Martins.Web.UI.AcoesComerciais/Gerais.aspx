...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Gerais.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.Gerais" %>
										...
										<table class="3D" cellSpacing="0" cellPadding="0" border="0">
											<tr>
												<td onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');"><asp:linkbutton id="btnCancelar" style="TEXT-DECORATION: none" runat="server" CausesValidation="False"
														href="GeraisListar.aspx"><IMG height="16" src="../Imagens/office/Sair.gif" width="16" align="absMiddle"> Sair</asp:linkbutton></td>
											</tr>
										</table>
									</td>
									<td>
					...
					<tr>
						<td class="darkbox" vAlign="top">
							...
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									<TR>
										<TD class="barra3">Filial:</TD>
										<TD class="barra1" colSpan="3">
											<asp:DropDownList id="cmbCODFILEMP" runat="server" Width="250px" Height="19px" Font-Size="11px" Font-Names="Arial"
												CssClass=""></asp:DropDownList></TD>
									</TR>
									<TR>
										<TD class="barra3">Último Acordo:</TD>
										<TD class="barra1" colSpan="3">
											<igtxt:WebTextEdit id="txtCODULTUTZPMS" runat="server" Height="19px" Width="100px" Font-Size="11px"
												Font-Names="Arial" CssClass="" Enabled="False" ReadOnly="True"></igtxt:WebTextEdit></TD>
									</TR>
									<TR>
										<TD class="barra3">Data do Processo:</TD>
										<TD class="barra1" colSpan="3">
											<igtxt:WebDateTimeEdit id="txtDATREFPCSPEDCMP" runat="server" Height="19px" Width="100px" Font-Size="11px"
												Font-Names="Arial" CssClass="" ReadOnly="True"></igtxt:WebDateTimeEdit></TD>
									</TR>
									<TR>
										<TD class="barra3">Valor Max. Arredondamento:</TD>
										<TD class="barra1" colSpan="3">
											<igtxt:WebCurrencyEdit id="txtVLRMAXARR" runat="server" Height="19px" Width="100px" Font-Size="11px" Font-Names="Arial"
												CssClass=""></igtxt:WebCurrencyEdit></TD>
									</TR>
									<TR>
										<TD class="barra3">Percentual Max. Arredondamento</TD>
										<TD class="barra1" colSpan="3">
											<igtxt:WebPercentEdit id="txtPERMAXARR" runat="server" Height="19px" Width="100px" Font-Size="11px" Font-Names="Arial"
												CssClass=""></igtxt:WebPercentEdit></TD>
									</TR>
									<TR>
										<TD class="barra3">Percentual de Juros para Saldo Neg. :</TD>
										<TD class="barra1" colSpan="3">
											<igtxt:WebPercentEdit id="txtPERJURSLDNEG" runat="server" Width="100px" Height="19px" Font-Size="11px"
												Font-Names="Arial" CssClass=""></igtxt:WebPercentEdit>&nbsp;
											<asp:Label id="Label1" runat="server" ForeColor="Black">am</asp:Label></TD>
									</TR>
									<TR>
										<TD class="barra3">Percentual dedução PIS/COFINS:</TD>
										<TD class="barra1" colSpan="3">
											<igtxt:WebPercentEdit id="txtPERPIS" runat="server" Height="19px" Width="100px" Font-Size="11px" Font-Names="Arial"
												CssClass=""></igtxt:WebPercentEdit></TD>
									</TR>
									<TR>
										<TD class="barra3">Fator Conv. Verba Ctt. Margem Crg:</TD>
										<TD class="barra1" colSpan="3">
											<igtxt:WebPercentEdit id="txtFTRCNVVBACTTMRGCRB" runat="server" Height="19px" Width="100px" Font-Size="11px"
												Font-Names="Arial" CssClass=""></igtxt:WebPercentEdit></TD>
									</TR>
									<TR>
									</TR>
								</TBODY>
