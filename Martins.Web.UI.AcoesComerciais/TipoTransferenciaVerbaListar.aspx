...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TipoTransferenciaVerbaListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.TipoTransferenciaVerbaListar" %>
				...
				<TR>
					...
					<TD class="barra1" width="126" height="19">
						<asp:DropDownList id="cmbCriterio" runat="server" Width="150px" Height="19px" Font-Size="11px" Font-Names="Arial"
							...
							<asp:ListItem Value="3">EMPENHO</asp:ListItem>
						</asp:DropDownList></TD>
					<TD class="barra1" height="19" vAlign="top" align="left">
						<igtxt1:WebTextEdit id="txtDescricao" runat="server" Height="19px" Width="150px" Font-Size="11px" Font-Names="Arial"
							Visible="False" CssClass=" "></igtxt1:WebTextEdit>
						<igtxt1:WebNumericEdit id="txtCodigo" runat="server" CssClass=" " Font-Names="Arial" Font-Size="11px"
							Height="19px" Width="60px" Visible="False"></igtxt1:WebNumericEdit>
						<asp:DropDownList id="cmbEmpenho" runat="server" Font-Names="Arial" Font-Size="11px" Height="19px"
							Width="250px" Visible="False" CssClass=""></asp:DropDownList></TD>
				</TR>
