Public Class AlteraFormaPagamentoListar
...
#End Region
    ...
    Private Sub btnInserir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnInserir.Click
        Controller.NavegarInserirAlteraFormaPagamento()
    End Sub
    ...
    Private Sub GravarCriteriosDePesquisa(ByVal urlFrame As String)
        ...
        End With
        Session("AlteraFormaPagamentoListar") = criterios
    End Sub
    ...
    Private Sub RestaurarCriteriosDePesquisa(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not Session("AlteraFormaPagamentoListarr") Is Nothing Then
            Try
                criterios = CType(Session("AlteraFormaPagamentoListar"), Collection)
