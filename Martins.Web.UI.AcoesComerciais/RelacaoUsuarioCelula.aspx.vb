Public Class RelacaoUsuarioCelula
...
#Region " Eventos "
    ...
    Private Sub btnCancelar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCancelar.Click
        Try
            Response.Redirect("RelacaoUsuarioCelulaListar.aspx")
        Catch ex As Exception
            Controller.TrataErro(Me.Page, ex)
        End Try
    End Sub
...
#Region " Métodos de Carga "
    ...
    Private Sub CarregaCelula()
        Util.carregarCmbCelula(Controller.ObterCelulas(Decimal.Zero, Decimal.Zero, Decimal.Zero, String.Empty), ddlCelula, New ListItem("", ""))
    End Sub
...
#Region " Metodos de Regras de Negocio "
    ...
    Private Function ValidarDados() As Boolean
        ...
        Dim ds As New wsAcoesComerciais.DatasetUsuarioXCelula
        Dim linha As wsAcoesComerciais.DatasetUsuarioXCelula.T0144920Row
        ds = Controller.ObterUsuariosXCelula(Convert.ToDecimal(ddlCelula.SelectedValue), ddlUsuario.SelectedValue)
        If ds.T0144920.Rows.Count > 0 Then
            Util.AdicionaJsAlert(Me.Page, "Essa relação já existe no banco de dados")
            Return False
        End If
    ...
    Private Sub SalvarDados()
        Try
            If ValidarDados() Then
                ...
                linha = ds.T0144920.NewT0144920Row
                ...
                ds.T0144920.AddT0144920Row(linha)

                Controller.AtualizarUsuarioXCelula(ds)

                Me.Response.Redirect("RelacaoUsuarioCelulaListar.aspx")
            End If
        Catch ex As Exception
            Controller.TrataErro(Me.Page, ex)
        End Try
