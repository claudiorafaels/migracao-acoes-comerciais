...
#End Region
    ...
    Private Sub btnInserir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnInserir.Click
        Controller.NavegarInserirEmpenho()
    End Sub
    ...
    Private Sub btnPesquisar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPesquisar.Click
        Try
            ...
            If Me.cmbCriterio.SelectedValue = "0" Then      'NENHUM
                lblFrame.Text = "<iframe src='" & "EmpenhoListarGrid.aspx?criterio=" & cmbCriterio.SelectedItem.Value & "' height=100% width=100% frameborder=0 ALLOWTRANSPARENCY scrolling=yes></iframe>"
            ElseIf Me.cmbCriterio.SelectedValue = "1" Then  'Consulta por CÓDIGO
                If Not IsNumeric(txtCODFRN.Text) Then
                    ...
                    Exit Try
                End If
                lblFrame.Text = "<iframe src='" & "EmpenhoListarGrid.aspx?criterio=" & cmbCriterio.SelectedItem.Value & "&TipDsnDscBnf=" & txtCODFRN.Text & "' height=100% width=100% frameborder=0 ALLOWTRANSPARENCY scrolling=yes></iframe>"
            ElseIf cmbCriterio.SelectedValue = "2" Then 'Consulta por DESCRIÇÃO
                If txtDescricao.Text.Trim.Length < 3 Then
                    ...
                    Exit Try
                End If
                lblFrame.Text = "<iframe src='" & "EmpenhoListarGrid.aspx?criterio=" & cmbCriterio.SelectedItem.Value & "&DesDsnDscBnf=" & txtDescricao.Text & "' height=100% width=100% frameborder=0 ALLOWTRANSPARENCY scrolling=yes></iframe>"
            End If
    ...
    Private Sub GravarCriteriosDePesquisa(ByVal urlFrame As String)
        ...
        End With
        Session("EmpenhoListar") = criterios
    End Sub
    Private Sub RestaurarCriteriosDePesquisa(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not Session("EmpenhoListar") Is Nothing Then
            Try
                criterios = CType(Session("EmpenhoListar"), Collection)
