<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TipoServico.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.TipoServico" %>
										...
										<table class="3D" cellSpacing="0" cellPadding="0" border="0">
											<tr>
												<td onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');"><asp:linkbutton id="btnCancelar" style="TEXT-DECORATION: none" runat="server" CausesValidation="False"
														href="TipoBaseCalculoListar.aspx"><IMG height="16" src="../Imagens/office/Sair.gif" width="16" align="absMiddle"> Sair</asp:linkbutton></td>
											</tr>
										</table>
									</td>
									<td>
							...
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									<TR>
										...
										<TD class="barra1" colSpan="3"><igtxt:webnumericedit id="txtTipSvcCttFrn" runat="server" Height="19px" Width="70px" CssClass=""
												Font-Size="11px" Font-Names="Arial" ReadOnly="True"></igtxt:webnumericedit></TD>
									</TR>
									<TR>
										<TD class="barra3">Descrição:</TD>
										<TD class="barra1" colSpan="3"><igtxt:webtextedit id="txtDesTipSvcCttFrn" runat="server" Height="19px" Width="300px" CssClass=" "
