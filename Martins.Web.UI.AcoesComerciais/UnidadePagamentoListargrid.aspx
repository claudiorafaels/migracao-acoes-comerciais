<%@ Page Language="vb" AutoEventWireup="false" Codebehind="UnidadePagamentoListargrid.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.UnidadePagamentoListarGrid" %>
		...
		<P>
			<form id="Form1" method="post" runat="server">
				<asp:datagrid id="dtgListar" runat="server" Width="800px" Font-Size="X-Small" AutoGenerateColumns="False"
					CssClass=" " PageSize="20" AllowPaging="True" DataKeyField="TipUndPgtCttFrn">
					...
					<Columns>
						...
						<asp:BoundColumn DataField="TipUndPgtCttFrn" SortExpression="TipUndPgtCttFrn" HeaderText="C&#211;DIGO">
							<HeaderStyle HorizontalAlign="Right" Width="80px"></HeaderStyle>
							<ItemStyle HorizontalAlign="Right"></ItemStyle>
						</asp:BoundColumn>
						<asp:BoundColumn DataField="DesTipUndPgtCttFrn" SortExpression="DesTipUndPgtCttFrn" HeaderText="DESCRI&#199;&#195;O"></asp:BoundColumn>
					</Columns>
