...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TipoEncargoFinanceiroListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.TipoEncargoFinanceiroListar" %>
...
//-->
	...
	<BODY onload="MM_preloadImages('../Imagens/lastpost.gif')">
		<form id="Form1" runat="server">
			<table cellSpacing="0" cellPadding="0" width="10" border="0" id="Table2">
				<tr>
			...
			<table height="424" cellSpacing="0" cellPadding="0" width="100%" border="0" id="Table3">
				<tbody>
					<tr>
					</tr>
				</tbody></table>
			<table height="40" cellSpacing="0" cellPadding="0" width="100%" border="0" id="Table4">
				<tbody>
					<tr>
						<td class="submenu2" vAlign="top" height="28">
							<table cellSpacing="0" cellPadding="0" border="0" id="tbOpcoes" runat="server">
								<tr>
									<td height="10">
										<table class="3D" cellSpacing="0" cellPadding="0" border="0" id="Table6">
											<tr>
									...
									<td height="10">
										<table class="3D" cellSpacing="0" cellPadding="0" border="0" id="Table7">
											<tr>
			...
			<TABLE class="tabela1" id="Table1" height="8" cellSpacing="0" cellPadding="0" width="100%"
				...
				<TR>
					...
					<TD class="barra1" height="19" vAlign="top" align="left">
						<igtxt1:WebTextEdit id="txtDescricao" runat="server" CssClass=" " Font-Names="Arial" Font-Size="11px"
							Height="19px" Width="150px" Visible="False"></igtxt1:WebTextEdit>
						<igtxt1:WebNumericEdit id="txtCodigo" runat="server" CssClass=" " Font-Names="Arial" Font-Size="11px"
