<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TipoTransferenciaVerbaListargrid.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.TipoTransferenciaVerbaListarGrid" %>
		...
		<P>
			<form id="Form1" method="post" runat="server">
				<asp:datagrid id="dtgListar" runat="server" Width="800px" Font-Size="X-Small" AutoGenerateColumns="False"
					CssClass=" " DataKeyField="CODTIPTRNVLRACOCMC" PageSize="20" AllowPaging="True">
					...
					<Columns>
						...
						<asp:BoundColumn DataField="CODTIPTRNVLRACOCMC" SortExpression="CODTIPTRNVLRACOCMC" HeaderText="CODIGO"></asp:BoundColumn>
						<asp:BoundColumn DataField="DESTIPTRNVLRACOCMC" SortExpression="DESTIPTRNVLRACOCMC" HeaderText="DESCRICAO"></asp:BoundColumn>
					</Columns>
