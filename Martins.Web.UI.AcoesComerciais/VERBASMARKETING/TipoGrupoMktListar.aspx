<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TipoGrupoMktListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.TipoGrupoMktListar" %>
							...
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									...
									<TR id="TRCodigo" runat="server">
										...
										<TD class="barra1" width="90%" colSpan="3"><igtxt:webnumericedit id="txtTIPGRPMKTFRN" runat="server" Width="70px" Font-Size="11px" Font-Names="Arial"></igtxt:webnumericedit></TD>
									</TR>
									<TR id="TRDescricao" runat="server">
										<TD class="barra3" width="10%">Descrição:</TD>
										<TD class="barra1" width="90%" colSpan="3"><igtxt:webtextedit id="txtDESGRPMKTFRN" runat="server" Width="200px" Font-Size="11px" Font-Names="Arial"></igtxt:webtextedit></TD>
									</TR>
								</TBODY>
							</TABLE>
							<igtbl:ultrawebgrid id=grdVerbasMarketing runat="server" Width="566px" Height="273px" ImageDirectory="/ig_common/Images/" DataSource="<%# DatasetTipoGrupoMarketing1 %>" DataMember="CADTIPGRPMKTFRNPesquisa">
								<DisplayLayout StationaryMargins="Header" AllowSortingDefault="OnClient" RowHeightDefault="20px"
									...
									RowSelectorsDefault="No" Name="grdVerbasMarketing" TableLayout="Fixed">
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White">
									...
									<FrameStyle Width="566px" BorderWidth="1px" Font-Size="11px" Font-Names="Arial" BorderColor="InactiveCaption"
								...
								<Bands>
									<igtbl:UltraGridBand AddButtonCaption="CADTIPGRPMKTFRNPesquisa" BaseTableName="CADTIPGRPMKTFRNPesquisa"
										Key="CADTIPGRPMKTFRNPesquisa" DataKeyField="TIPGRPMKTFRN">
										<Columns>
											...
											<igtbl:UltraGridColumn HeaderText="Tipo Grupo" Key="TIPGRPMKTFRN" IsBound="True" Width="65px" DataType="System.Int32"
												...
												<Header Key="TIPGRPMKTFRN" Caption="Tipo Grupo">
													<Style HorizontalAlign="Center">
													</Style>
													<RowLayoutColumnInfo OriginX="1"></RowLayoutColumnInfo>
												</Header>
											</igtbl:UltraGridColumn>
											<igtbl:UltraGridColumn HeaderText="Descri&#231;&#227;o do Grupo" Key="DESGRPMKTFRN" IsBound="True" Width="300px"
												BaseColumnName="DESGRPMKTFRN">
												<Footer Key="DESGRPMKTFRN">
													<RowLayoutColumnInfo OriginX="2"></RowLayoutColumnInfo>
												</Footer>
												<Header Key="DESGRPMKTFRN" Caption="Descri&#231;&#227;o do Grupo">
													<RowLayoutColumnInfo OriginX="2"></RowLayoutColumnInfo>
												</Header>
											</igtbl:UltraGridColumn>
											<igtbl:UltraGridColumn HeaderText="Percentual" Key="PERGRPMKTFRN" IsBound="True" Width="70px" Format="###,###,##0.00"
												...
												<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
												<Header Key="PERGRPMKTFRN" Caption="Percentual">
													<Style HorizontalAlign="Center">
													</Style>
													<RowLayoutColumnInfo OriginX="3"></RowLayoutColumnInfo>
												</Header>
											</igtbl:UltraGridColumn>
											<igtbl:UltraGridColumn HeaderText="Tipo Perc. Mkt." Key="INDORIVBAMKT" IsBound="True" Width="80px" BaseColumnName="INDORIVBAMKT">
												<CellStyle HorizontalAlign="Center"></CellStyle>
												<Footer Key="INDORIVBAMKT">
													<RowLayoutColumnInfo OriginX="4"></RowLayoutColumnInfo>
												</Footer>
												<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
												<Header Key="INDORIVBAMKT" Caption="Tipo Perc. Mkt.">
													<Style HorizontalAlign="Center">
													</Style>
													<RowLayoutColumnInfo OriginX="4"></RowLayoutColumnInfo>
												</Header>
