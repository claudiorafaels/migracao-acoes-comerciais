...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TipoGrupoMktManter.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.TipoGrupoMktManter" %>
							...
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									<TR id="TRCodigo" runat="server">
										<TD class="barra3" width="10%">Código Grupo:
										</TD>
										<TD class="barra1" width="90%" colSpan="3"><igtxt:webnumericedit id="txtTIPGRPMKTFRN" runat="server" Width="70px" Enabled="False" Font-Names="Arial"
												Font-Size="11px"></igtxt:webnumericedit></TD>
									</TR>
									<TR id="TRDescricao" runat="server">
										<TD class="barra3" width="10%">Descrição:</TD>
										<TD class="barra1" width="90%" colSpan="3"><igtxt:webtextedit id="txtDESGRPMKTFRN" runat="server" Width="200px" Font-Names="Arial" Font-Size="11px"
												MaxLength="50"></igtxt:webtextedit></TD>
									</TR>
									<TR>
										<TD class="barra3" width="10%">Percentual:&nbsp;
										</TD>
										<TD class="barra1" width="90%" colSpan="3"><igtxt:webnumericedit id="txtPERGRPMKTFRN" runat="server" Width="50px" Font-Names="Arial" Font-Size="11px"
												MinDecimalPlaces="Two"></igtxt:webnumericedit></TD>
									</TR>
									<TR>
										<TD class="barra3" width="10%">Tipo Ori. Perc. Mkt.:&nbsp;
										</TD>
										<TD class="barra1" width="90%" colSpan="3"><asp:radiobuttonlist id="rblINDORIVBAMKT" runat="server" Width="239px" RepeatColumns="3">
												<asp:ListItem Value="0">Nenhum</asp:ListItem>
												<asp:ListItem Value="1">Contrato</asp:ListItem>
												<asp:ListItem Value="2">CMV</asp:ListItem>
