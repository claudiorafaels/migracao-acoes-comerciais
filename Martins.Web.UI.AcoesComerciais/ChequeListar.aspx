...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ChequeListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.ChequeListar" %>
		...
		<form id="Form1" runat="server">
			...
			<TABLE class="tabela1" id="Table1" height="8" cellSpacing="0" cellPadding="0" width="100%"
				...
				<TR>
					...
					<TD class="barra1" width="126" height="19"><asp:dropdownlist id="cmbCriterio" runat="server" CssClass="" AutoPostBack="True" Font-Names="Arial"
							Font-Size="11px" Height="19px" Width="150px">
							<asp:ListItem Value="1">PER&#205;ODO RECEBIMENTO</asp:ListItem>
							<asp:ListItem Value="2">DATA RECEBIMENTO</asp:ListItem>
							<asp:ListItem Value="3">PER&#205;ODO/FORNECEDOR</asp:ListItem>
							<asp:ListItem Value="4" Selected="True">N&#218;MERO</asp:ListItem>
						</asp:dropdownlist></TD>
					<TD class="barra1" vAlign="top" align="left" height="19">
						<asp:label id="Label1" runat="server" Visible="False">De:</asp:label><igtxt:webdatetimeedit id="txtDataInicial" runat="server" CssClass="" Font-Names="Arial" Font-Size="11px"
							Height="19px" Width="70px" Visible="False" MaxValue="2025-12-31" MinValue="1950-12-31"></igtxt:webdatetimeedit><asp:label id="LblA" runat="server" Visible="False">A</asp:label><igtxt:webdatetimeedit id="txtDataFinal" runat="server" CssClass="" Font-Names="Arial" Font-Size="11px"
							Height="19px" Width="70px" Visible="False" MaxValue="2025-12-31" MinValue="1950-12-31"></igtxt:webdatetimeedit><igtxt1:webnumericedit id="txtCodigo" runat="server" CssClass="" Width="70px" MaxLength="10"></igtxt1:webnumericedit><BR>
						<asp:label id="LblFornecedor" runat="server" Visible="False" ForeColor="Black">Fornecedor</asp:label><uc1:wucfornecedor id="ucFornecedor" runat="server" Visible="False"></uc1:wucfornecedor></TD>
				</TR>
