...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RecebimentoListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.RecebimentoListar" %>
				...
				<TR>
					...
					<TD class="barra1" height="19" vAlign="top" align="left">
						<igtxt:WebDateTimeEdit id="txtDataInicial" runat="server" Width="70px" Height="19px" Font-Size="10px" Font-Names="Arial"
							Visible="False"></igtxt:WebDateTimeEdit>
						...
						<igtxt1:WebTextEdit id="txtCodigo" runat="server" Height="19px" Width="60px" Font-Size="10px" Font-Names="Arial"></igtxt1:WebTextEdit>
