...
Public Class RelatorioBaixaAcordo1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RelatorioBaixaAcordo.rpt"
        End Get
...
Public Class CachedRelatorioBaixaAcordo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RelatorioBaixaAcordo1 = New RelatorioBaixaAcordo1
        rpt.Site = Me.Site
        Return rpt
    End Function
