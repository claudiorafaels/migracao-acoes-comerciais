...
Public Class RelatorioPrevisaoApuracao
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "RelatorioPrevisaoApuracao.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRelatorioPrevisaoApuracao
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RelatorioPrevisaoApuracao = New RelatorioPrevisaoApuracao
        rpt.Site = Me.Site
        Return rpt
    End Function
