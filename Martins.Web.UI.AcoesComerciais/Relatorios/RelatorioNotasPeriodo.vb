...
Public Class RelatorioNotasPeriodo
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "RelatorioNotasPeriodo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRelatorioNotasPeriodo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RelatorioNotasPeriodo = New RelatorioNotasPeriodo
        rpt.Site = Me.Site
        Return rpt
    End Function
