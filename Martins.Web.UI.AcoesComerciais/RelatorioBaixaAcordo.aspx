<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RelatorioBaixaAcordo.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.RelatorioBaixaAcordo" %>
										...
										<table class="3D" cellSpacing="0" cellPadding="0" border="0">
											<tr>
												<td onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');">
													<asp:linkbutton id="btnImprimir" style="TEXT-DECORATION: none" runat="server" CausesValidation="False"><IMG height="16" src="../Imagens/office/imprimir.gif" width="16" align="absMiddle">  Imprimir</asp:linkbutton></td>
											</tr>
										</table>
									</td>
									<td>
										<table class="3D" cellSpacing="0" cellPadding="0" border="0">
											<tr>
												<td onmouseover="mOvr(this,'#E1EBF4');" onclick="mClk('#');" onmouseout="mOut(this,'');">
													...
													<IMG height="16" src="../Imagens/office/Sair.gif" width="16" align="absMiddle"> Sair</asp:linkbutton></td>
											</tr>
										</table>
									</td>
									<td>
							...
							<TABLE class="tabela1" id="Table1" cellSpacing="0" cellPadding="2" width="100%" border="0">
								<TBODY>
									<TR>
										...
										<TD class="barra1" style="WIDTH: 315px" height="19">
											<P align="right">&nbsp;</P>
										</TD>
										<TD class="barra1" height="19"></TD>
										<TD class="barra1" height="19"></TD>
									...
									<TR>
										<TD class="barra3">Data da última alteração</TD>
										<TD class="barra1" style="WIDTH: 315px" colSpan="3">
											<igtxt:WebDateTimeEdit id="txtDataUltimaAlteracao" runat="server" Width="100px" Font-Size="11px" CssClass=""
												Font-Names="Arial" EditModeFormat="dd/MM/yyyy" DisplayModeFormat="dd/MM/yyyy"></igtxt:WebDateTimeEdit></TD>
									</TR>
									<TR>
									</TR>
								</TBODY>
