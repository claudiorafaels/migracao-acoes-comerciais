...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="LancamentoListar.aspx.vb" Inherits="Martins.Web.UI.AcoesComerciais.LancamentoListar" %>
		...
		<form id="Form1" runat="server">
			...
			<TABLE class="tabela1" id="Table1" height="8" cellSpacing="0" cellPadding="0" width="100%"
				...
				<TR>
					...
					<TD class="barra1" width="126" height="19"><asp:dropdownlist id="cmbCriterio" runat="server" AutoPostBack="True" Font-Names="Arial" Font-Size="11px"
							Height="19px" Width="150px" CssClass="">
							...
							<asp:ListItem Value="4" Selected="True">NUMERO</asp:ListItem>
						</asp:dropdownlist></TD>
					<TD class="barra1" vAlign="top" align="left" height="19"><igtxt:webdatetimeedit id="txtDataInicial" runat="server" Font-Names="Arial" Font-Size="11px" Height="19px"
							Width="70px" Visible="False" CssClass=""></igtxt:webdatetimeedit><asp:label id="LblA" runat="server" Visible="False">A</asp:label><igtxt:webdatetimeedit id="txtDataFinal" runat="server" Font-Names="Arial" Font-Size="11px" Height="19px"
							Width="70px" Visible="False" CssClass=""></igtxt:webdatetimeedit><asp:label id="LblFornecedor" runat="server" Visible="False" ForeColor="Black">Fornecedor</asp:label><igtxt1:webnumericedit id="txtCodigo" runat="server" Font-Names="arial" Font-Size="11px" Width="60px" CssClass=""
							SelectionOnFocus="CaretToEnd"></igtxt1:webnumericedit><asp:dropdownlist id="cmbNomeFornecedor" runat="server" AutoPostBack="True" Font-Names="Arial" Font-Size="11px"
							Height="19px" Width="170px" Visible="False" CssClass=""></asp:dropdownlist><igtxt:webtextedit id="txtNomeFornecedor" runat="server" Font-Names="Arial" Font-Size="11px" Width="170px"
							Visible="False" CssClass=""></igtxt:webtextedit><asp:linkbutton id="btnBuscarFornecedor" style="TEXT-DECORATION: none" runat="server" Visible="False">
