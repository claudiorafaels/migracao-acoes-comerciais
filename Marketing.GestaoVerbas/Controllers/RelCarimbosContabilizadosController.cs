...
{
    public class RelCarimbosContabilizadosController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            gridSetings.Filtro.DtInicioAcordo = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1);
            gridSetings.Filtro.DtFimAcordo = DateTime.Now;
            gridSetings.Filtro.DtInicioRecebidos = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1);
            ...
            if (retornoApi.Sucesso)
            {
                List<DestinoObjetivoViewModel> listaObjetivos = (retornoApi2.Resultado as List<DestinoObjetivoViewModel>);
                listaObjetivos.Sort((x, y) => string.Compare(x.CodNomObjetivo, y.CodNomObjetivo));

                ViewBag.ListObjetivos = listaObjetivos;
            }
            else
            {
                Util.PreencheTempDataAlerta(this, retornoApi);
                ...
                case "Receber":
                    if (gridSetings.Filtro.IndAnaliticoSintetico == "Analitico")
                    {
                        ...
                        if (retornoApi.Sucesso)
                        {
                            ...
                            return PartialView("~/Views/RelCarimbosContabilizados/gridValoresAReceberAnalitico.cshtml", gridSetingsReceberAnalitico);
                        }
                    }
                    else if (gridSetings.Filtro.IndAnaliticoSintetico == "Sintetico")
                    {
                        ...
                        if (retornoApi.Sucesso)
                        {
                            ...
                            return PartialView("~/Views/RelCarimbosContabilizados/gridValoresAReceberSintetico.cshtml", gridSetingsReceberSintetico);
                        }
                    }
                    break;
                case "Recebidos":
                    if (gridSetings.Filtro.IndAnaliticoSintetico == "Analitico")
                    {
                        ...
                        if (retornoApi.Sucesso)
                        {
                            ...
                            return PartialView("~/Views/RelCarimbosContabilizados/gridValoresRecebidosAnalitico.cshtml", gridSetingsRecebidosAnalitico);
                        }
                    }
                    else if (gridSetings.Filtro.IndAnaliticoSintetico == "Sintetico")
                    {
                        ...
                        if (retornoApi.Sucesso)
                        {
                            ...
                            return PartialView("~/Views/RelCarimbosContabilizados/gridValoresRecebidosSintetico.cshtml", gridSetingsRecebidosSintetico);
                        }
                    }
                    break;
                case "Novos":
                    if (gridSetings.Filtro.IndAnaliticoSintetico == "Analitico")
                    {
                        ...
                        if (retornoApi.Sucesso)
                        {
                            ...
                            return PartialView("~/Views/RelCarimbosContabilizados/gridNovosAcordosAnalitico.cshtml", gridSetingsNovosAnalitico);
                        }
                    }
                    else if (gridSetings.Filtro.IndAnaliticoSintetico == "Sintetico")
                    {
                        ...
                        if (retornoApi.Sucesso)
                        {
                            ...
                            return PartialView("~/Views/RelCarimbosContabilizados/gridNovosAcordosSintetico.cshtml", gridSetingsNovosSintetico);
                        }
                    }
                    break;
                case "Cancelados":
                    if (gridSetings.Filtro.IndAnaliticoSintetico == "Analitico")
                    {
                        ...
                        if (retornoApi.Sucesso)
                        {
                            ...
                            return PartialView("~/Views/RelCarimbosContabilizados/gridAcordosCanceladosAnalitico.cshtml", gridSetingsCanceladosAnalitico);
                        }
                    }
                    else if (gridSetings.Filtro.IndAnaliticoSintetico == "Sintetico")
                    {
                        ...
                        if (retornoApi.Sucesso)
                        {
                            ...
                            return PartialView("~/Views/RelCarimbosContabilizados/gridAcordosCanceladosSintetico.cshtml", gridSetingsAcordosCanceladosSintetico);
                        }
                    }
                    break;
                default:
