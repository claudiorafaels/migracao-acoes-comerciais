...
{
    public class RelatoriosVerbasEmitidasController : Controller
    {
        // GET: Relatorios
        public ActionResult Index()
        {
            ...
            gridSetings.Filtro.DtCadastroCarimboInicio = DateTime.Now.AddDays(-7);
            gridSetings.Filtro.DtCadastroCarimboFim = DateTime.Now;
            gridSetings.Filtro.DtCadastroNegociacaoInicio = DateTime.Now.AddDays(-7);
            gridSetings.Filtro.DtCadastroNegociacaoFim = DateTime.Now;
        ...
        public ActionResult Pesquisar(GridSetings<RelatoriosVerbasEmitidasViewModel> gridSetings)
        {
            ...
            return PartialView("~/Views/RelatoriosVerbasEmitidas/index.cshtml", gridSetings);
        }
            ...
            if (retornoApi.Sucesso)
            {
                ...
                if (gridSetings.Filtro.IndRelVisao == "N")
                {
                    TempData[handle] = (new Core.CSV<RelatoriosVerbasEmitidasViewModel>()).ConvertCSV(gridSetings.Result
                                            , new string[] { "CodNegociacaoVerba"
                                                           , "NomNegociacaoVerba"
                                                           , "NomStatusNegociacao"
                                                           , "DtCadastroNegociacao"
                                                           , "CodFornecedor"
                                                           , "NomFornecedor"
                                                           , "CodFilialEmpresa"
                                                           , "NomFilialEmpresa"
