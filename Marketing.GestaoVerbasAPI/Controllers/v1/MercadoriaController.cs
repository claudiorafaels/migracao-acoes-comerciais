...
namespace Marketing.GestaoVerbasAPI.Controllers.v1
{
    ...
    /// </summary>
    public class MercadoriaController : ApiController
    {
        /// <summary>
        ...
        [Route("Mercadoria/{pagina}/{tamanho}/{coluna}/{sentido}/list")]
        [HttpPost]
        public ListResult<Mercadoria> List(int pagina, int tamanho, string coluna, string sentido, [FromBody]Mercadoria filtro)
        {
            return MercadoriaBLL.List(pagina, tamanho, coluna, sentido, filtro);
        }
        ...
        [Route("Mercadoria/ListLookup")]
        [HttpGet]
        public List<Mercadoria> ListLookup()
        {
            return MercadoriaBLL.ListLookup();
        }
    }
}