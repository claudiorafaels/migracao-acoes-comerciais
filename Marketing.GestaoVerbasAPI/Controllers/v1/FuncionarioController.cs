...
{
    /// <summary>
    /// Controlador responvavel pela entidade Fucionario
    /// </summary>
    public class FuncionarioController : ApiController
    {
        ...
        [Route("funcionario/{pagina}/{tamanho}/{coluna}/{sentido}/list")]
        [HttpPost]
        public ListResult<Funcionario> List(int pagina, int tamanho, string coluna, string sentido, [FromBody]Funcionario filtro)
        {
            return FuncionarioBLL.List(pagina, tamanho, coluna, sentido, filtro);
        }
    }
}